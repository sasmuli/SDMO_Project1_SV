...
@nx._dispatchable(preserve_all_attrs=True, mutates_input={"not copy": 4}, returns_graph=True)
...
@nx._dispatchable(preserve_edge_attrs=True, mutates_input={"not copy": 3}, returns_graph=True)
