...
class TestPolys:
    ...
    def test_sh_legendre(self):
        with np.errstate(all="ignore"):
            self.check_poly(
                _ufuncs.eval_sh_legendre, orth.sh_legendre, param_ranges=[], x_range=[0, 1]
            )

    def test_genlaguerre(self):
        self.check_poly(
            _ufuncs.eval_genlaguerre, orth.genlaguerre, param_ranges=[(-0.99, 10)], x_range=[0, 100]
        )
    ...
    def test_hermitenorm(self):
        self.check_poly(
            _ufuncs.eval_hermitenorm, orth.hermitenorm, param_ranges=[], x_range=[-100, 100]
        )
...
class TestRecurrence:
    ...
    def test_jacobi(self):
        self.check_poly(
            _ufuncs.eval_jacobi, param_ranges=[(-0.99, 10), (-0.99, 10)], x_range=[-1, 1]
        )
