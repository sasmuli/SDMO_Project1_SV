...
def show_versions(show_dirs=True):
    ...
    print("\nstatsmodels\n===========\n")
    if has_sm:
        print("Installed: {} ({})".format(safe_version(statsmodels), dirname(statsmodels.__file__)))
    else:
        print("Not installed")
    ...
    try:
        ...
        print(
            "numpy: {} ({})".format(
                safe_version(numpy, ["version", "version"]), dirname(numpy.__file__)
            )
        )
    except ImportError:
        print("numpy: Not installed")
    ...
    try:
        ...
        print(
            "scipy: {} ({})".format(
                safe_version(scipy, ["version", "version"]), dirname(scipy.__file__)
            )
        )
    except ImportError:
        print("scipy: Not installed")
    ...
    try:
        ...
        print("    dateutil: {} ({})".format(safe_version(dateutil), dirname(dateutil.__file__)))
    except ImportError:
        print("    dateutil: not installed")
    ...
    try:
        ...
        print("cvxopt: {} ({})".format(safe_version(info, "version"), dirname(info.__file__)))
    except ImportError:
        print("cvxopt: Not installed")
    ...
    try:
        ...
        print("IPython: {} ({})".format(safe_version(IPython), dirname(IPython.__file__)))
    except ImportError:
        print("IPython: Not installed")
    try:
        import jinja2

        print("    jinja2: {} ({})".format(safe_version(jinja2), dirname(jinja2.__file__)))
    except ImportError:
        print("    jinja2: Not installed")
    ...
    try:
        ...
        print("    pygments: {} ({})".format(safe_version(pygments), dirname(pygments.__file__)))
    except ImportError:
        print("    pygments: Not installed")
    ...
    try:
        ...
        print("virtualenv: {} ({})".format(safe_version(virtualenv), dirname(virtualenv.__file__)))
    except ImportError:
        print("virtualenv: Not installed")
