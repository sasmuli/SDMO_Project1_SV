        ...
        **kwds,
        ...
        if dep_var == "nobs":
            ...
            for ii, es in enumerate(effect_size):
                ...
                ax.plot(
                    nobs, power, lw=lw, alpha=plt_alpha, color=colors[ii], label="es=%4.2F" % es
                )
...
class TTestPower(Power):
    ...
    def solve_power(
        self, effect_size=None, nobs=None, alpha=None, power=None, alternative="two-sided"
    ):
        ...
        *attaches*
        ...
        return super().solve_power(
            effect_size=effect_size, nobs=nobs, alpha=alpha, power=power, alternative=alternative
        )
...
class FTestPower(Power):
    ...
    # method is only added to have explicit keywords and docstring
    def solve_power(
        self, effect_size=None, df_num=None, df_denom=None, alpha=None, power=None, ncc=1, **kwargs
    ):
...
class FTestPowerF2(Power):
    ...
    # method is only added to have explicit keywords and docstring
    def solve_power(
        self, effect_size=None, df_num=None, df_denom=None, alpha=None, power=None, ncc=1
    ):
        """Solve for any one parameter of the power of a F-test
    ...
    def solve_power(self, effect_size=None, nobs=None, alpha=None, power=None, k_groups=2):
        ...
        if effect_size is None:
            return self._solve_effect_size(
                effect_size=effect_size, nobs=nobs, alpha=alpha, k_groups=k_groups, power=power
            )
