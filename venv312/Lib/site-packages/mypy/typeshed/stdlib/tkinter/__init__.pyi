...
class Misc:
    ...
    def option_add(
        ...
        value,
        priority: (
            int | Literal["widgetDefault", "startupFile", "userDefault", "interactive"] | None
        ) = None,
    ) -> None: ...
...
class Tk(Misc, Wm):
    ...
    if sys.version_info < (3, 11):
        @deprecated(
            "Deprecated since Python 3.9; removed in Python 3.11. Use `splitlist()` instead."
        )
        def split(self, arg, /): ...
...
class Image(_Image):
    ...
    tk: _tkinter.TkappType
    def __init__(
        self, imgtype, name=None, cnf={}, master: Misc | _tkinter.TkappType | None = None, **kw
    ) -> None: ...
    def __del__(self) -> None: ...
