...
res_multtest1 = np.array(
    [
        [
            5.2365677720800003e-05,
            5.2365677720800005e-04,
            5.2365677720800005e-04,
            5.2365677720800005e-04,
            5.2353339704891422e-04,
            5.2353339704891422e-04,
            5.2365677720800005e-04,
            1.5337740764175588e-03,
        ],
        [
            2.8140506198000000e-04,
            2.8140506197999998e-03,
            2.5326455578199999e-03,
            2.5326455578199999e-03,
            2.8104897961789277e-03,
            2.5297966317768816e-03,
            1.4070253098999999e-03,
            4.1211324652269442e-03,
        ],
        [
            1.4987731079600001e-02,
            1.4987731079600000e-01,
            1.1990184863680001e-01,
            1.1990184863680001e-01,
            1.4016246580579017e-01,
            1.1379719679449507e-01,
            4.9959103598666670e-02,
            1.4632862843720582e-01,
        ],
        [
            2.0273268879800001e-02,
            2.0273268879799999e-01,
            1.4191288215860001e-01,
            1.4191288215860001e-01,
            1.8520270949069695e-01,
            1.3356756197485375e-01,
            5.0683172199499998e-02,
            1.4844940238274187e-01,
        ],
        [
            1.7709695272300000e-01,
            1.0000000000000000e00,
            1.0000000000000000e00,
            9.6783382430900000e-01,
            8.5760763426056130e-01,
            6.8947825122356643e-01,
            3.5419390544599999e-01,
            1.0000000000000000e00,
        ],
        [
            6.4219392379499995e-01,
            1.0000000000000000e00,
            1.0000000000000000e00,
            9.6783382430900000e-01,
            9.9996560644133570e-01,
            9.9413539782557070e-01,
            8.9533672797500008e-01,
            1.0000000000000000e00,
        ],
        [
            6.8084594763299999e-01,
            1.0000000000000000e00,
            1.0000000000000000e00,
            9.6783382430900000e-01,
            9.9998903512635740e-01,
            9.9413539782557070e-01,
            8.9533672797500008e-01,
            1.0000000000000000e00,
        ],
        [
            7.1626938238000004e-01,
            1.0000000000000000e00,
            1.0000000000000000e00,
            9.6783382430900000e-01,
            9.9999661886871472e-01,
            9.9413539782557070e-01,
            8.9533672797500008e-01,
            1.0000000000000000e00,
        ],
        [
            8.3854136755300002e-01,
            1.0000000000000000e00,
            1.0000000000000000e00,
            9.6783382430900000e-01,
            9.9999998796038225e-01,
            9.9413539782557070e-01,
            9.3171263061444454e-01,
            1.0000000000000000e00,
        ],
        [
            9.6783382430900000e-01,
...
class TestMultiTests3(CheckMultiTestsMixin):
    @classmethod
    def setup_class(cls):
        cls.methods = ["b", "s", "sh", "hs", "h", "fdr_i", "fdr_n", "fdr_tsbh"]
        cls.alpha = 0.05
        cls.res2 = res0_large
...
def test_pvalcorrection_reject(alpha, method, ii):
    ...
    pval1 = np.hstack((np.linspace(0.0001, 0.0100, ii), np.linspace(0.05001, 0.11, 10 - ii)))
...
def test_issorted(method):
    ...
    pvals = (
        np.array([31, 9958111, 7430818, 8653643, 9892855, 876, 2651691, 145836, 9931, 6174747])
        * 1e-7
    )
