...
array_function_dispatch = functools.partial(array_function_dispatch, module="numpy.strings")
...
def encode(a, encoding=None, errors=None):
    ...
    """
    return _to_bytes_or_str_array(
        _vec_string(a, np.object_, "encode", _clean_args(encoding, errors)), np.bytes_(b"")
    )
