...
def _chandrupatla(
    func, a, b, *, args=(), xatol=None, xrtol=None, fatol=None, frtol=0, maxiter=None, callback=None
):
    ...
    maxiter = (
        math.log2(finfo.max) - math.log2(finfo.smallest_normal) if maxiter is None else maxiter
    )
    work = _RichResult(
        x1=x1,
        f1=f1,
    ...
    def post_termination_check(work):
        ...
        t[j] = f1j / (f1j - f2j) * f3j / (f3j - f2j) - alphaj * f1j / (f3j - f1j) * f2j / (
            f2j - f3j
        )
