...
class ProductNestedFixed(NestedFixedRule):
    ...
    def __init__(self, base_rules):
        for rule in base_rules:
            if not isinstance(rule, NestedFixedRule):
                raise ValueError("base rules for product need to be instance of" "NestedFixedRule")
    ...
    @cached_property
    def nodes_and_weights(self):
        nodes = _cartesian_product([rule.nodes_and_weights[0] for rule in self.base_rules])
