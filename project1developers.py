...
csv_path = os.path.join("project1devs", "devs.csv")
with open(csv_path, "r", newline="", encoding="utf-8-sig", errors="strict") as csvfile:
...
df = df[
    ["name_1", "email_1", "name_2", "email_2", "c1", "c2", "c3.1", "c3.2", "c4", "c5", "c6", "c7"]
]
