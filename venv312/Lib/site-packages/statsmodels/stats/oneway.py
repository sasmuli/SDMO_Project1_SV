...
def equivalence_oneway(
    ...
    res0 = anova_oneway(
        data, groups=groups, use_var=use_var, welch_correction=welch_correction, trim_frac=trim_frac
    )
...
def test_scale_oneway(
    data, method="bf", center="median", transform="abs", trim_frac_mean=0.1, trim_frac_anova=0.0
):
    ...
    res = anova_oneway(
        xxd, groups=None, use_var=method, welch_correction=True, trim_frac=trim_frac_anova
    )
...
def equivalence_scale_oneway(
    ...
    res = equivalence_oneway(
        xxd, equiv_margin, use_var=method, welch_correction=True, trim_frac=trim_frac_anova
    )
