...
from scipy._lib._array_api import xp_assert_close, get_xp_devices, xp_device, array_namespace
...
@skip_xp_backends("cupy", reason="CuPy has not implemented the `device` param")
@skip_xp_backends("jax.numpy", reason="JAX has not implemented the `device` param")
class TestFFTFreq:
