...
BOOST_TESTS = [
    data(
        assoc_legendre_p_boost_, "assoc_legendre_p_ipp-assoc_legendre_p", (0, 1, 2), 3, rtol=1e-11
    ),
    ...
    data(jvp, "bessel_j_prime_large_data_ipp-bessel_j_prime_large_data", (0, 1j), 2, rtol=2e-11),
