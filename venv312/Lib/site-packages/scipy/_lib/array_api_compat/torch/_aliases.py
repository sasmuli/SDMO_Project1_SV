...
def max(
    x: array, /, *, axis: Optional[Union[int, Tuple[int, ...]]] = None, keepdims: bool = False
) -> array:
...
def sort(
    x: array, /, *, axis: int = -1, descending: bool = False, stable: bool = True, **kwargs
) -> array:
...
def concat(
    arrays: Union[Tuple[array, ...], List[array]], /, *, axis: Optional[int] = 0, **kwargs
) -> array:
    if axis is None:
...
def tensordot(
    x1: array, x2: array, /, *, axes: Union[int, Tuple[Sequence[int], Sequence[int]]] = 2, **kwargs
) -> array:
