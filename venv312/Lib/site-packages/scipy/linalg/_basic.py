...
def solve(
    ...
    # Banded case
        ...
        a1, n_below, n_above = (a1.T, n_above, n_below) if transposed else (a1, n_below, n_above)
        ...
        a2[n_below:, :] = ab
        _, _, x, info = gbsv(n_below, n_above, a2, b1, overwrite_ab=True, overwrite_b=overwrite_b)
        _solve_check(n, info)
...
def lstsq(
    ...
    if driver in ("gelss", "gelsd"):
        ...
        if info < 0:
            raise ValueError(
                "illegal value in %d-th argument of internal %s" % (-info, lapack_driver)
            )
