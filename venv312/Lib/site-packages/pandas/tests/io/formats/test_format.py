...
class TestDataFrameFormatting:
            ...
            df = DataFrame(
                {
                    ...
                    "B": [
                        "a" * np.random.default_rng(2).integers(max_len - 1, max_len + 1)
                        for _ in range(10)
                    ],
                }
            )
    ...
    def test_truncate_with_different_dtypes(self, dtype):
        ...
        # 11594
        ser = Series(
            [datetime(2012, 1, 1)] * 10 + [datetime(1012, 1, 2)] + [datetime(2012, 1, 3)] * 10,
            dtype=dtype,
        )
...
class TestDatetime64Formatter:
    ...
    def test_datetime64formatter_tz_ms(self):
        x = (
            Series(np.array(["2999-01-01", "2999-01-02", "NaT"], dtype="datetime64[ms]"))
