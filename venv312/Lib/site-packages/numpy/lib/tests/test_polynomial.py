...
class TestPolynomial:
    ...
    def test_roots(self):
        ...
        for i in np.logspace(10, 25, num=1000, base=10):
            ...
            assert_almost_equal(
                res, tgt, 14 - int(np.log10(i))
            )  # Adapting the expected precision according to the root value, to take into account numerical calculation error
    ...
    def test_polyfit(self):
        ...
        val = [[4.3964, -5.0052, 0.4878], [-5.0052, 6.8067, -0.9089], [0.4878, -0.9089, 0.3337]]
