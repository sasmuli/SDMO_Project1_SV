...
def plot_corr(
    dcorr, xnames=None, ynames=None, title=None, normcolor=False, ax=None, cmap="RdYlBu_r"
):
    ...
    axim = ax.imshow(
        dcorr, cmap=cmap, interpolation="nearest", extent=(0, nvars, 0, nvars), vmin=vmin, vmax=vmax
    )
    ...
    if isinstance(xnames, list) and len(xnames) == 0:
        ...
        ax.set_xticklabels(xnames, fontsize="small", rotation=45, horizontalalignment="right")
