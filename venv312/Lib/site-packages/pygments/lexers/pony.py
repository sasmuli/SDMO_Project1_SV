...
class PonyLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                words(
                    ("addressof", "and", "as", "consume", "digestof", "is", "isnt", "not", "or"),
                    suffix=r"\b",
                ),
                Operator.Word,
            ),
        ...
        "typename": [
            (_caps + r"?((?:\s)*)(_?[A-Z]\w*)", bygroups(Keyword, Text, Name.Class), "#pop")
        ],
        "methodname": [
            (_caps + r"?((?:\s)*)(_?[a-z]\w*)", bygroups(Keyword, Text, Name.Function), "#pop")
        ],
        "nested_comment": [
            (r"[^*/]+", Comment.Multiline),
