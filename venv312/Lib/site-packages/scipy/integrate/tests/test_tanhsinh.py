...
class TestTanhSinh:
    ...
    def test_integral_transforms(self, limits, ref, xp):
        ...
        assert (
            xp_test.isdtype(logres.integral.dtype, "real floating")
            if ref > 0
    ...
    def test_options_and_result_attributes(self, xp):
        ...
        xp_test = array_namespace(xp.asarray(1.0))  # need xp.atan
    ...
    def test_minlevel(self, maxlevel, xp):
        ...
        xp_test = array_namespace(xp.asarray(1.0))
    ...
    def test_gh_22681_finite_error(self, xp):
        ...
        res = _tanhsinh(f, xp.asarray(0.0), xp.asarray(1.0), atol=0, rtol=0, maxlevel=10)
