...
class TestLogit:
    ...
    def test_float64(self):
        a = np.concatenate(
            (np.linspace(0, 1, 10, dtype=np.float64), [1e-8, 0.4999999999999, 0.50000000001])
        )
...
class TestLogExpit:
    ...
    def test_basic_float64(self):
        x = np.array(
            [-32, -20, -10, -3, -1, -0.1, -1e-9, 0, 1e-9, 0.1, 1, 10, 100, 500, 710, 725, 735]
        )
        y = log_expit(x)
        #
    ...
    def test_basic_float32(self):
        x = np.array(
            [-32, -20, -10, -3, -1, -0.1, -1e-9, 0, 1e-9, 0.1, 1, 10, 100], dtype=np.float32
        )
        y = log_expit(x)
        #
        # Expected values were computed with mpmath:
