...
def run_all_random_functions(seed):
    ...
    t(
        ...
        H,
        method=lambda G, weight: approx.simulated_annealing_tsp(G, "greedy", weight, seed=seed),
    )
    t(
        approx.traveling_salesman_problem,
        H,
        method=lambda G, weight: approx.threshold_accepting_tsp(G, "greedy", weight, seed=seed),
    )
