...
class Anes:
    ...
    def mnlogit_basezero():
        ...
        obj.margeff_dydx_dummy_overall_se = np.array(
            [
                [0.0037314453, 0.0094102332, 0.000688838, 0.0079744554, 0.0019365971, 0.0243914836],
                [0.0038215262, 0.0095938828, 0.0007410885, 0.008259353, 0.0019984087, 0.0317628806],
                [0.0031045718, 0.00785814, 0.0006504353, 0.0067892866, 0.0018060332, 0.0262803561],
                [
                    0.0019756086,
                    0.0051031194,
                    0.0003862449,
                ...
                [0.0034443743, 0.0097296187, 0.0006774867, 0.0075996454, 0.0021993881, 0.038600835],
                [
                    0.0032003518,
                    0.0098741227,
                    0.0006335772,
        ...
        obj.margeff_eydx_dummy_overall = np.array(
            [
                [0.03939188, -0.65758371, 0.01750922, -0.12131806, -0.03613241, -3.2132513],
                [0.02752366, -0.383165, -0.00830021, -0.03652935, -0.03286046, -1.8741853],
                [-0.05006681, -0.2719659, -0.00626481, 0.06525323, 0.01012554, -2.0058029],
                [-0.05239558, -0.22549142, 0.00025015, -0.13104416, 0.01114517, -0.27052009],
                [-0.00296374, 0.25627809, 0.00140513, 0.03358712, 0.02296041, 1.3302701],
                [0.00328283, 0.2800168, -0.0083912, 0.04332782, 0.01575863, 1.8441023],
                [-0.03257068, 0.98346111, -0.00122118, 0.10847807, 0.0406456, 2.9119099],
            ]
        ).T
        ...
        obj.margeff_eydx_dummy_overall_se = np.array(
            [
                ...
                [0.0262290023, 0.0724479385, 0.005174736, 0.0567743614, 0.0144447083, 0.3015738731],
                [
                    0.0321415498,
                    0.0895589422,
                    0.0067480662,
...
class DiscreteL1:
    ...
    def mnlogit():
        ...
        obj = Namespace()
        obj.params = [
            [0.00100163, -0.05864195, -0.06147822, -0.04769671, -0.05222987, -0.09522432],
            [0.0, 0.03186139, 0.12048999, 0.83211915, 0.92330292, 1.5680646],
            [-0.0218185, -0.01988066, -0.00808564, -0.00487463, -0.01400173, -0.00562079],
            [0.0, 0.03306875, 0.0, 0.02362861, 0.05486435, 0.14656966],
            [0.0, 0.04448213, 0.03252651, 0.07661761, 0.07265266, 0.0967758],
            [0.90993803, -0.50081247, -2.08285102, -5.26132955, -4.86783179, -9.31537963],
        ]
        obj.conf_int = [
            [
