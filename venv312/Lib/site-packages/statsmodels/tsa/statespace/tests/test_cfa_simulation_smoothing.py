...
class CheckPosteriorMoments:
    @classmethod
    def setup_class(
        cls, model_class, missing=None, mean_atol=0, cov_atol=0, use_complex=False, *args, **kwargs
    ):
    ...
    def test_posterior_cov(self):
        ...
        for t in range(self.mod.nobs):
            ...
            assert_allclose(
                actual[tm:t1m, tm:t1m], self.res.smoothed_state_cov[..., t], atol=self.cov_atol
            )
...
class TestDFM(CheckPosteriorMoments):
    ...
    def setup_class(cls, missing=None, *args, **kwargs):
        ...
        super().setup_class(dynamic_factor.DynamicFactor, missing=missing, *args, **kwargs)
...
class TestDFMComplex(CheckPosteriorMoments):
    ...
    def setup_class(cls, missing=None, *args, **kwargs):
        ...
        kwargs["factor_order"] = 1
        super().setup_class(
            dynamic_factor.DynamicFactor, missing=missing, use_complex=True, *args, **kwargs
        )
...
class TestUnobservedComponents(CheckPosteriorMoments):
    ...
    def setup_class(cls, missing=None, *args, **kwargs):
        ...
        super().setup_class(structural.UnobservedComponents, missing=missing, *args, **kwargs)
