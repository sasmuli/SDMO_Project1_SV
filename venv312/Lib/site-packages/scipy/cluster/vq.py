...
from scipy._lib._array_api import _asarray, array_namespace, xp_size, xp_copy
...
@_transition_to_rng("seed")
def kmeans2(
    data, k, iter=10, thresh=1e-5, minit="random", missing="warn", check_finite=True, *, rng=None
):
    """
