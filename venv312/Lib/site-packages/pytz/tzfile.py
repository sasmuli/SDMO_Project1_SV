...
def build_tzinfo(zone, fp):
    ...
    if len(ttinfo) == 1 or len(transitions) == 0:
        ...
        cls = type(
            zone,
            (StaticTzInfo,),
            dict(zone=zone, _utcoffset=memorized_timedelta(ttinfo[0][0]), _tzname=ttinfo[0][2]),
        )
    else:
        ...
        cls = type(
            zone,
            (DstTzInfo,),
            dict(zone=zone, _utc_transition_times=transitions, _transition_info=transition_info),
        )
