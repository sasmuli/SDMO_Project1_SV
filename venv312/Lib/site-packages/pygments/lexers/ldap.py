    ...
    tokens = {
        "root": [
            ...
            (
                ...
                bygroups(
                    Keyword, Punctuation, Whitespace, Name.Other, Whitespace, Keyword, Whitespace
                ),
                "after-control",
            ),
            (
...
class LdaprcLexer(RegexLexer):
    ...
    _tls_keywords = (
        r"TLS_(?:CACERT|CACERTDIR|CERT|ECNAME|KEY|CIPHER_SUITE|PROTOCOL_MIN|RANDFILE|CRLFILE)"
    )
    ...
    _integer_keywords = (
        r"KEEPALIVE_(?:IDLE|PROBES|INTERVAL)|NETWORK_TIMEOUT|PORT|SIZELIMIT|TIMELIMIT|TIMEOUT"
    )
