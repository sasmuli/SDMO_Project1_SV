...
class _csr_base(_cs_matrix):
    ...
    def tocsc(self, copy=False):
        ...
        M, N = self.shape
        idx_dtype = self._get_index_dtype((self.indptr, self.indices), maxval=max(self.nnz, M))
    ...
    def _get_array(self, idx):
        ...
        csr_sample_values(M, N, self.indptr, self.indices, self.data, row.size, row, col, val)
