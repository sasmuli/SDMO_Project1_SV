...
@pytest.mark.skipif(PYTHON_IMPL_WASM, reason="Multiprocessing is not supported in WASM/Pyodide")
...
def test_hdr_alpha(close_figures):
    try:
        ...
        extra_quant_t = np.vstack(
            [
                [25.1, 26.5, 27.0, 26.4, 25.4, 24.1, 23.0, 22.0, 21.7, 22.1, 22.7, 23.8],
                [23.4, 24.8, 25.0, 23.9, 22.4, 21.1, 20.0, 19.3, 19.2, 19.4, 20.1, 21.3],
            ]
        )
