...
_MACHAR_PARAMS = {
    ntypes.double: {"itype": ntypes.int64, "fmt": "%24.16e", "title": _title_fmt.format("double")},
    ntypes.single: {"itype": ntypes.int32, "fmt": "%15.7e", "title": _title_fmt.format("single")},
    ntypes.longdouble: {
        "itype": ntypes.longlong,
        "fmt": "%s",
        "title": _title_fmt.format("long double"),
    },
    ntypes.half: {"itype": ntypes.int16, "fmt": "%12.5e", "title": _title_fmt.format("half")},
}
