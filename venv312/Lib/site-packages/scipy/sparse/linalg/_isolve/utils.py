...
from scipy.sparse.linalg._interface import aslinearoperator, LinearOperator, IdentityOperator
...
def make_system(A, M, x0, b):
    ...
    if x0 is None:
        ...
        if not (x.shape == (N, 1) or x.shape == (N,)):
            raise ValueError(f"shapes of A {A.shape} and " f"x0 {x.shape} are incompatible")
        x = x.ravel()
