...
_StepT_co = TypeVar(
    "_StepT_co", covariant=True, default=_StartT_co | _StopT_co
...
class complex:
    ...
    if sys.version_info >= (3, 14):
        @classmethod
        def from_number(
            cls, number: complex | SupportsComplex | SupportsFloat | SupportsIndex, /
        ) -> Self: ...
...
class memoryview(Sequence[_I]):
    ...
    def __exit__(
        ...
        ),  # noqa: PYI036 # This is the module declaring BaseException
...
class slice(Generic[_StartT_co, _StopT_co, _StepT_co]):
    ...
    @overload
    def __new__(
        cls, start: None, stop: None = None, step: None = None, /
    ) -> slice[Any, Any, Any]: ...
    # unary overloads ------------------------------------------------------------------
    @overload
...
class map(Iterator[_S]):
    ...
    if sys.version_info >= (3, 14):
        @overload
        def __new__(
            cls, func: Callable[[_T1], _S], iterable: Iterable[_T1], /, *, strict: bool = False
        ) -> Self: ...
        @overload
        def __new__(
            cls,
        ...
        @overload
        def __new__(
            cls, func: Callable[[_T1, _T2], _S], iterable: Iterable[_T1], iter2: Iterable[_T2], /
        ) -> Self: ...
        @overload
        def __new__(
            cls,
...
@overload
def pow(
    base: _SupportsPow3[_E_contra, _M_contra, _T_co], exp: _E_contra, mod: _M_contra
) -> _T_co: ...
@overload
...
if sys.version_info >= (3, 11):
    ...
    class BaseExceptionGroup(BaseException, Generic[_BaseExceptionT_co]):
        ...
        @overload
        def split(self, matcher_value: Callable[[_BaseExceptionT_co | Self], bool], /) -> tuple[
            BaseExceptionGroup[_BaseExceptionT_co] | None,
            BaseExceptionGroup[_BaseExceptionT_co] | None,
        ]: ...
