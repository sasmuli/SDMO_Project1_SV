...
_ElementCreateArgsCrossPlatform: TypeAlias = (
    ...
    tuple[
        Literal["image"],
        tkinter._ImageSpec,
        Unpack[tuple[_ImageStatespec, ...]],
        _ElementCreateImageKwargs,
    ]
...
if sys.platform == "win32" and sys.version_info >= (3, 13):
    ...
    _ElementCreateVsapiKwargsDict: TypeAlias = (
        _ElementCreateVsapiKwargsPadding
        | _ElementCreateVsapiKwargsMargin
        | _ElementCreateVsapiKwargsSize
    )
    _ElementCreateArgs: (
        TypeAlias
    ) = (  # noqa: Y047  # It doesn't recognise the usage below for whatever reason
...
class Style:
    ...
    def configure(
        self, style: str
    ) -> dict[str, Any] | None: ...  # Returns None if no configuration.
    @overload
    ...
    @overload
    def map(
        self, style: str, query_opt: None = None, **kw: Iterable[_Statespec]
    ) -> dict[str, _Statespec]: ...
    def lookup(
        self,
        style: str,
    ...
    @overload
    def layout(
        self, style: str, layoutspec: _LayoutSpec
    ) -> list[Never]: ...  # Always seems to return an empty list
    @overload
    ...
    @overload
    def element_create(
        self, elementname: str, etype: Literal["from"], themename: str, fromelement: str = ..., /
    ) -> None: ...
    ...
    def theme_create(
        self, themename: str, parent: str | None = None, settings: _ThemeSettings | None = None
    ) -> None: ...
