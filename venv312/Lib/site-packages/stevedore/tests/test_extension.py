...
class TestCallback(utils.TestCase):
    ...
    def test_list_entry_points(self):
        ...
        self.assertEqual({"e1", "e2", "t1", "t2"}, set(map(operator.attrgetter("name"), n)))
    ...
    def test_use_cache(self):
        ...
        with mock.patch(
            "stevedore._cache.get_group_all", side_effect=AssertionError("called get_group_all")
        ):
    ...
    def test_map_propagate_exceptions(self):
        ...
        em = extension.ExtensionManager(
            "stevedore.test.extension", invoke_on_load=True, propagate_map_exceptions=True
        )
