...
class ColRange(Strict):
    ...
    def __eq__(self, other):
        if isinstance(other, self.__class__):
            ...
            return str(self) == other or f"{self.min_col}:{self.max_col}"
        return False
...
class RowRange(Strict):
    ...
    def __eq__(self, other):
        if isinstance(other, self.__class__):
            ...
            return str(self) == other or f"{self.min_row}:{self.max_row}"
        return False
...
class PrintTitles(Strict):
    ...
    def __eq__(self, other):
        if isinstance(other, self.__class__):
            return self.cols == other.cols and self.rows == other.rows and self.title == other.title
        elif isinstance(other, str):
