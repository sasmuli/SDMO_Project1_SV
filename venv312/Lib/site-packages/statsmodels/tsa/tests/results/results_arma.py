...
class Y_arma14:
    def __init__(self, method="mle"):
        if method == "mle":
            ...
            self.bse = [0.06106330, 0.07381130, 0.07257705, 0.06857992, 0.07046048]
            # self.cov_params = [
            ...
            self.tvalues = [12.643194, 3.847252, -11.501785, 2.301399, 6.126120]
...
class Y_arma41:
    def __init__(self, method="mle"):
        if method == "mle":
            ...
            self.arroots = [1.0209 - 0j, 0.2966 - 0.9835j, 0.2966 + 0.9835j, -1.4652 + 0.0000j]
            ...
            self.arroots = [1.0184 + 0.0000j, 0.2960 - 0.9803j, 0.2960 + 0.9803j, -1.4747 + 0.0000j]
            ...
            self.tvalues = [9.0887381, -3.4315100, -0.6786792, 7.8938778, 0.2503143]
...
class Y_arma22:
    def __init__(self, method="mle"):
        if method == "mle":
            ...
            self.bse = [0.065073834100, 0.060522519771, 0.065569474599, 0.071275323591]
            self.cov_params = [
...
class Y_arma02:
    def __init__(self, method="mle"):
        if method == "mle":
            ...
            self.cov_params = [[0.0024260, 0.00078704], [0.00078704, 0.0025545]]
            ...
            self.arroots = None
            self.maroots = [-1.0844 + 0.0j, 1.3395 + 0.0j]
...
class Y_arma14c:
    def __init__(self, method="mle"):
        if method == "mle":
            ...
            self.pvalues = [1.82e-193, 9.80e-05, 0.0352, 5.37e-07, 0.0725, 6.84e-07]
            ...
            self.pvalues = [0.0050, 8.31e-10, 0.0991, 6.64e-12, 0.0528, 8.09e-7]
...
class Y_arma41c:
    def __init__(self, method="mle"):
        if method == "mle":
            ...
            self.arroots = [1.0141 + 0.0000j, 0.3036 - 0.9765j, 0.3036 + 0.9765j, -1.2455 + 0.0000j]
...
class Y_arma50c:
    def __init__(self, method="mle"):
        if method == "mle":
            ...
            self.pvalues = [1.50e-46, 9.06e-34, 6.53e-05, 0.0010, 0.0003, 0.0060]
...
class Y_arma02c:
    def __init__(self, method="mle"):
        if method == "mle":
            ...
            self.arroots = None
            self.maroots = [-1.1004 + 0.0j, 1.4117 + 0.0j]
