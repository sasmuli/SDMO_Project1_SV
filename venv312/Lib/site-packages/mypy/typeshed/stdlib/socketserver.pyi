...
_AfInet6Address: TypeAlias = tuple[
    str | bytes | bytearray, int, int, int
]  # address acceptable for an AF_INET6 socket
...
class BaseServer:
    ...
    def get_request(
        self,
    ) -> tuple[Any, Any]: ...  # Not implemented here, but expected to exist on subclasses
