...
def test_validate_contraction_modes():
    ...
    assert_(
        (true_modes1, true_modes2) == (modes1, modes2),
    ...
    modes = ((0, 2), (0, 2))
    batched_modes1, batched_modes2 = _validate_contraction_modes(
        shape1, shape2, modes, batched_modes=True
    )
    assert_(
        (true_batched_modes1, true_batched_modes2) == (batched_modes1, batched_modes2),
