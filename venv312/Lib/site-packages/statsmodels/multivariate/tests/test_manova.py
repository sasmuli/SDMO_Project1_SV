...
def test_manova_sas_example():
    ...
    assert_almost_equal(
        r["Loc"]["stat"].loc["Hotelling-Lawley trace", "Value"], 0.58210348, decimal=8
    )
    assert_almost_equal(r["Loc"]["stat"].loc["Roy's greatest root", "Value"], 0.35530890, decimal=8)
