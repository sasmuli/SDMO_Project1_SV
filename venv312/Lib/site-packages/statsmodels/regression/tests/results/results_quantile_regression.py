...
epanechnikov_hsheather_q75.table = np.array(
    [
        [0.6440143, 0.0122001, 52.79, 0.000, 0.6199777, 0.6680508],
...
epanechnikov_hsheather_q75.bwidth = 0.1090401129546568
...
epanechnikov_hsheather_q75.f_r = 0.0044685860313942
epanechnikov_hsheather_q75.N = 235
epanechnikov_hsheather_q75.q_v = 745.2352905273438
epanechnikov_hsheather_q75.q = 0.75
...
biweight_bofinger.table = np.array(
    [
        [0.5601805, 0.0136491, 41.04, 0.000, 0.533289, 0.5870719],
...
biweight_hsheather.table = np.array(
    [
        [0.5601805, 0.0128449, 43.61, 0.000, 0.5348735, 0.5854875],
...
biweight_chamberlain.table = np.array(
    [
        [0.5601805, 0.0114969, 48.72, 0.000, 0.5375294, 0.5828315],
...
epanechnikov_bofinger.table = np.array(
    [
        [0.5601805, 0.0209663, 26.72, 0.000, 0.5188727, 0.6014882],
...
epanechnikov_hsheather.table = np.array(
    [
        [0.5601805, 0.0170484, 32.86, 0.000, 0.5265918, 0.5937692],
...
epanechnikov_chamberlain.table = np.array(
    [
        [0.5601805, 0.0130407, 42.96, 0.000, 0.5344876, 0.5858733],
...
epan2_bofinger.table = np.array(
    [
        [0.5601805, 0.0143484, 39.04, 0.000, 0.5319113, 0.5884496],
...
epan2_hsheather.table = np.array(
    [
        [0.5601805, 0.0131763, 42.51, 0.000, 0.5342206, 0.5861403],
...
epan2_chamberlain.table = np.array(
    [
        [0.5601805, 0.0117925, 47.50, 0.000, 0.5369469, 0.583414],
...
rectangle_bofinger.table = np.array(
    [
        [0.5601805, 0.0158331, 35.38, 0.000, 0.5289861, 0.5913748],
...
rectangle_hsheather.table = np.array(
    [
        [0.5601805, 0.0137362, 40.78, 0.000, 0.5331174, 0.5872435],
...
rectangle_chamberlain.table = np.array(
    [
        [0.5601805, 0.0118406, 47.31, 0.000, 0.5368522, 0.5835087],
...
triangle_bofinger.table = np.array(
    [
        [0.5601805, 0.0138712, 40.38, 0.000, 0.5328515, 0.5875094],
...
triangle_hsheather.table = np.array(
    [
        [0.5601805, 0.0128874, 43.47, 0.000, 0.5347898, 0.5855711],
...
triangle_chamberlain.table = np.array(
    [
        [0.5601805, 0.0115725, 48.41, 0.000, 0.5373803, 0.5829806],
...
gaussian_bofinger.table = np.array(
    [
        [0.5601805, 0.0197311, 28.39, 0.000, 0.5213062, 0.5990547],
...
gaussian_hsheather.table = np.array(
    [
        [0.5601805, 0.016532, 33.88, 0.000, 0.5276092, 0.5927518],
...
gaussian_chamberlain.table = np.array(
    [
        [0.5601805, 0.0128123, 43.72, 0.000, 0.5349378, 0.5854232],
...
cosine_bofinger.table = np.array(
    [
        [0.5601805, 0.0121011, 46.29, 0.000, 0.536339, 0.5840219],
...
cosine_hsheather.table = np.array(
    [
        [0.5601805, 0.0116679, 48.01, 0.000, 0.5371924, 0.5831685],
...
cosine_chamberlain.table = np.array(
    [
        [0.5601805, 0.0106479, 52.61, 0.000, 0.539202, 0.5811589],
...
parzen_bofinger.table = np.array(
    [
        [0.5601805, 0.012909, 43.39, 0.000, 0.5347471, 0.5856138],
...
parzen_hsheather.table = np.array(
    [
        [0.5601805, 0.0122688, 45.66, 0.000, 0.5360085, 0.5843524],
...
parzen_chamberlain.table = np.array(
    [
        [0.5601805, 0.0110507, 50.69, 0.000, 0.5384084, 0.5819526],
