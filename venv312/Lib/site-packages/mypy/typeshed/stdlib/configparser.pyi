...
class Interpolation:
    def before_get(
        self, parser: _Parser, section: _SectionName, option: str, value: str, defaults: _Section
    ) -> str: ...
    def before_set(
        self, parser: _Parser, section: _SectionName, option: str, value: str
    ) -> str: ...
    def before_read(
        self, parser: _Parser, section: _SectionName, option: str, value: str
    ) -> str: ...
...
if sys.version_info < (3, 13):
    ...
    class LegacyInterpolation(Interpolation):
        def before_get(
            self, parser: _Parser, section: _SectionName, option: str, value: str, vars: _Section
        ) -> str: ...
...
class RawConfigParser(_Parser):
    ...
    if sys.version_info < (3, 12):
        @deprecated(
            "Deprecated since Python 3.2; removed in Python 3.12. Use `parser.read_file()` instead."
        )
    ...
    @overload
    def getint(
        self, section: _SectionName, option: str, *, raw: bool = False, vars: _Section | None = None
    ) -> int: ...
    @overload
    def getint(
        self,
    ...
    @overload
    def items(
        self, section: _SectionName, raw: bool = False, vars: _Section | None = None
    ) -> list[tuple[str, str]]: ...
...
class SectionProxy(MutableMapping[str, str]):
    ...
    @overload
    def getint(
        self, option: str, *, raw: bool = False, vars: _Section | None = None
    ) -> int | None: ...
    @overload
    def getint(
        self, option: str, fallback: _T = ..., *, raw: bool = False, vars: _Section | None = None
    ) -> int | _T: ...
    @overload
    def getfloat(
        self, option: str, *, raw: bool = False, vars: _Section | None = None
...
class DuplicateSectionError(Error):
    ...
    lineno: int | None
    def __init__(
        self, section: _SectionName, source: str | None = None, lineno: int | None = None
    ) -> None: ...
...
class InterpolationMissingOptionError(InterpolationError):
    reference: str
    def __init__(
        self, option: str, section: _SectionName, rawval: object, reference: str
    ) -> None: ...
