        ...
        if y.size == 0:
            ...
            if n == 3 and bc[0] == "not-a-knot" and bc[1] == "not-a-knot":
                ...
                if bc_start == "periodic":
                    ...
                    s1 = solve_banded(
                        (1, 1), Ac, b1, overwrite_ab=False, overwrite_b=False, check_finite=False
                    )

                    s2 = solve_banded(
                        (1, 1), Ac, b2, overwrite_ab=False, overwrite_b=False, check_finite=False
                    )
                    ...
                    s = solve_banded(
                        (1, 1), A, b, overwrite_ab=True, overwrite_b=True, check_finite=False
                    )
