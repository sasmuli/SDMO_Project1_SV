...
results = {
    ...
    "Omega_11": pd.read_csv(os.path.join(results_path, "cfa_tvpvar_Omega_11.csv"), header=None),
    ...
    "Omega_22": pd.read_csv(os.path.join(results_path, "cfa_tvpvar_Omega_22.csv"), header=None),
}
...
class TVPVAR(mlemodel.MLEModel):
    ...
    def state_names(self):
        ...
        for i in range(self.k_endog):
            ...
            state_names += [f"L1.{other_name}->{endog_name}" for other_name in self.endog_names]
        return state_names
