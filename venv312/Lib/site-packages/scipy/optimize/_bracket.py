...
def _bracket_minimum_iv(func, xm0, xl0, xr0, xmin, xmax, factor, args, maxiter):
    ...
    xm0 = xp.asarray(xm0)[()]
    if not xp.isdtype(xm0.dtype, "numeric") or xp.isdtype(xm0.dtype, "complex floating"):
...
def _bracket_minimum(
    func, xm0, *, xl0=None, xr0=None, xmin=None, xmax=None, factor=None, args=(), maxiter=1000
):
    ...
    def check_termination(work):
        ...
        i = (
            (work.fl >= work.fm) & (work.fr > work.fm) | (work.fl > work.fm) & (work.fr >= work.fm)
        ) & ~stop
        work.status[i] = eim._ECONVERGED
        stop[i] = True
