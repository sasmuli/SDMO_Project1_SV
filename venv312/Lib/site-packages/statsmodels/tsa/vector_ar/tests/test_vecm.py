    ...
    for ds in datasets:
        for dt in ds.dt_s_list:
            ...
            for causing_ind in sublists(v_ind, 1, len(v_ind) - 1):
                ...
                granger_sm_ind_exog = results_sm_exog[ds][dt].test_granger_causality(
                    caused_ind, causing_ind
                )
                granger_sm_ind_exog_coint = results_sm_exog_coint[ds][dt].test_granger_causality(
                    caused_ind, causing_ind
                )
    ...
    for ds in datasets:
        for dt in ds.dt_s_list:
            ...
            for causing_ind in sublists(v_ind, 1, len(v_ind) - 1):
                ...
                inst_sm_ind_exog_coint = results_sm_exog_coint[ds][dt].test_inst_causality(
                    causing_ind
                )
