...
class TestHyp2f1:
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(
                Hyp2f1TestCase(a=0.5, b=0.2, c=-10, z=0.2 + 0.2j, expected=np.inf + 0j, rtol=0)
            ),
            pytest.param(
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(
                Hyp2f1TestCase(
                    a=0.5, b=0.2, c=1.5, z=1 + 0j, expected=1.1496439092239847 + 0j, rtol=1e-15
                ),
            ),
            pytest.param(
                Hyp2f1TestCase(
                    a=12.3, b=8.0, c=20.31, z=1 + 0j, expected=69280986.75273195 + 0j, rtol=1e-15
                ),
            ),
            pytest.param(
                Hyp2f1TestCase(
    ...
    @pytest.mark.parametrize(
        ...
        [
            pytest.param(
                Hyp2f1TestCase(
                    a=0.5, b=0.2, c=1.3, z=-1 + 0j, expected=0.9428846409614143 + 0j, rtol=1e-15
                ),
            ),
            pytest.param(
                Hyp2f1TestCase(
