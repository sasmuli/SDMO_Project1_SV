...
class TestOnewayEquivalenc:
    ...
    def test_equivalence_equal(self):
        ...
        res = equivalence_oneway_generic(
            f, n_groups, nobs.sum(), eps, res0.df, alpha=0.05, margin_type="wellek"
        )
    ...
    def test_equivalence_welch(self):
        ...
        res = equivalence_oneway_generic(
            f_stat, n_groups, nobs.sum(), eps, res0.df, alpha=0.05, margin_type="wellek"
        )
        ...
        pow_ = power_equivalence_oneway(
            eps, eps, nobs.sum(), n_groups=n_groups, df=None, alpha=0.05, margin_type="wellek"
        )
        ...
        pow_ = power_equivalence_oneway(
            es_w, eps, nobs_t, n_groups=n_groups, df=None, alpha=0.05, margin_type="wellek"
        )
        assert_allclose(pow_, 0.1552, atol=0.007)
        ...
        pow_ = power_equivalence_oneway(
            es**2, margin, nobs_t, n_groups=n_groups, df=None, alpha=0.05, margin_type="f2"
        )
        assert_allclose(pow_, 0.1552, atol=0.007)
...
class TestOnewayScale:
    ...
    def setup_class(cls):
        yt0 = np.array(
            [102.0, 320.0, 0.0, 107.0, 198.0, 200.0, 4.0, 20.0, 110.0, 128.0, 7.0, 119.0, 309.0]
        )
    ...
    def test_levene(self):
        ...
        res0 = smo.test_scale_oneway(
            data, method="equal", center="median", transform="abs", trim_frac_mean=0.2
        )
        ...
        df = [2, 40]
        res0 = smo.test_scale_oneway(
            data, method="equal", center="trimmed", transform="abs", trim_frac_mean=0.2
        )
        assert_allclose(res0.pvalue, p_value, rtol=1e-13)
        assert_allclose(res0.statistic, statistic, rtol=1e-13)
        ...
        res0 = smo.test_scale_oneway(
            data, method="equal", center="mean", transform="abs", trim_frac_mean=0.2
        )
        assert_allclose(res0.pvalue, p_value, rtol=1e-13)
        assert_allclose(res0.statistic, statistic, rtol=1e-13)
    ...
    def test_options(self):
        ...
        res = smo.test_scale_oneway(
            data, method="unequal", center="median", transform="abs", trim_frac_mean=0.2
        )
        ...
        res = smo.test_scale_oneway(
            data, method="bf", center="median", transform="abs", trim_frac_mean=0.2
        )
        assert_allclose(res.pvalue, p_value, rtol=1e-13)
        assert_allclose(res.statistic, statistic, rtol=1e-13)
        assert_allclose(res.df, df)
        ...
        df = (2.0, 40.0)
        res = smo.test_scale_oneway(
            data, method="equal", center="mean", transform="square", trim_frac_mean=0.2
        )
        assert_allclose(res.pvalue, p_value, rtol=1e-13)
        assert_allclose(res.statistic, statistic, rtol=1e-13)
        ...
        res = smo.test_scale_oneway(
            data, method="unequal", center=0, transform="identity", trim_frac_mean=0.2
        )
    ...
    def test_equivalence(self):
        ...
        # compare no transform with standard anova
        res = smo.equivalence_scale_oneway(
            data, 0.5, method="unequal", center=0, transform="identity"
        )
...
def test_simulate_equivalence():
    ...
    pow_ = [
        power_equivalence_oneway(
            es_, margin, nobs_t, n_groups=k_groups, df=None, alpha=0.05, margin_type="f2"
        )
        for es_ in es_alt_li
    ]
