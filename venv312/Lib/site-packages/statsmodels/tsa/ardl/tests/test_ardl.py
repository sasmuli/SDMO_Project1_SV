...
def test_bounds_test_simulation(case):
    ...
    res = mod.fit()
    bounds_result = res.bounds_test(case=case, asymptotic=False, seed=[1, 2, 3, 4], nsim=10_000)
...
def test_bounds_test_simulate_order():
    ...
    assert "BoundsTestResult" in str(bounds_result)
    bounds_result_sim = res.bounds_test(3, asymptotic=False, nsim=10_000, seed=[1, 2, 3])
