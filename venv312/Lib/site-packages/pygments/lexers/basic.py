...
class MonkeyLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"(?i)(?:End|Return|Public|Private|Extern|Property|" r"Final|Abstract)\b",
                Keyword.Reserved,
            ),
            # Flow Control stuff
            (
    ...
    tokens = {
        "root": [
            ...
            (
                r"(DECLARE)(\s+)([A-Z]+)(\s+)(\S+)",
                bygroups(
                    Keyword.Declaration, Text.Whitespace, Name.Variable, Text.Whitespace, Name
                ),
            ),
            (
                r"(DIM)(\s+)(SHARED)(\s+)([^\s(]+)",
    ...
    tokens = {
        "root": [
            ...
            (
                ...
                bygroups(
                    Keyword, Whitespace, Keyword, Whitespace, Keyword, Whitespace, Number.Integer
                ),
            ),
            (
            ...
            (
                ...
                bygroups(
                    Keyword.Declaration, Whitespace, Keyword.Declaration, Whitespace, Name.Property
                ),
            ),
            (r"rem\s.*[^\n]*", Comment.Single),
