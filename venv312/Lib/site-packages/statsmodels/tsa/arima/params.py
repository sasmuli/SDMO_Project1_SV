...
class SARIMAXParams:
    ...
    def seasonal_ar_poly(self):
        ...
        if s > 0:
            ...
            coef = np.r_[
                1, np.pad(np.reshape(expanded, (-1, 1)), [(0, 0), (s - 1, 0)], "constant").flatten()
            ]
        return Polynomial(coef)
    ...
    def seasonal_ar_poly(self, value):
        ...
        value = validate_basic(
            value, 1 + s * self.spec.max_seasonal_ar_order, title="seasonal AR polynomial"
        )
        if value[0] != 1:
    ...
    def is_stationary(self):
        ...
        validate_basic(
            self.seasonal_ar_params, self.k_seasonal_ar_params, title="seasonal AR coefficients"
        )
    ...
    def is_invertible(self):
        ...
        validate_basic(
            self.seasonal_ma_params, self.k_seasonal_ma_params, title="seasonal MA coefficients"
        )
