...
class Categorical(NDArrayBackedExtensionArray, PandasObject, ObjectStringArrayMixin):
    ...
    def __array_ufunc__(self, ufunc: np.ufunc, method: str, *inputs, **kwargs):
        ...
        raise TypeError(
            f"Object with dtype {self.dtype} cannot perform " f"the numpy op {ufunc.__name__}"
        )
    ...
    # "ExtensionDtype"
    @classmethod
    def _empty(cls, shape: Shape, dtype: CategoricalDtype) -> Self:  # type: ignore[override]
        """
    ...
    def _repr_categories(self) -> list[str]:
        ...
        if self.categories.dtype == "str":
            ...
            formatter = cast(ExtensionArray, self.categories._values)._formatter(boxed=False)

        format_array = partial(fmt.format_array, formatter=formatter, quoting=QUOTE_NONNUMERIC)
    ...
    def _str_map(self, f, na_value=lib.no_default, dtype=np.dtype("object"), convert: bool = True):
    ...
    def _str_get_dummies(self, sep: str = "|"):
        ...
        return NumpyExtensionArray(self.to_numpy(str, na_value="NaN"))._str_get_dummies(sep)
