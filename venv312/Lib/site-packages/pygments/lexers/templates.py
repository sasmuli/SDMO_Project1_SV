            ...
            while True:
                ...
                # block starts
                    ...
                    # % raw ruby statements
                        ...
                        r_idx = 0
                        for r_idx, r_token, r_value in self.ruby_lexer.get_tokens_unprocessed(
                            tag[1:]
                        ):
    ...
    tokens = {
        "root": [
            ...
            (
                r"(\$)(\w+)(\{(%)?)(.*?)((?(4)%)\})",
                bygroups(
                    Punctuation, Name.Builtin, Punctuation, None, using(PythonLexer), Punctuation
                ),
            ),
            ...
            (
                r"(\$\{(%)?)(.*?)((!)(.*?))?((?(2)%)\})",
                bygroups(
                    Punctuation, None, using(PythonLexer), Name.Builtin, None, None, Punctuation
                ),
            ),
            (r"#", Other),
        ],
    ...
    tokens = {
        ...
        "tag-or-block": [
            ...
            (
                r"(capture)(\s+)([^\s%]+)(\s*)(%\})",
                bygroups(
                    Name.Tag, Whitespace, using(this, state="variable"), Whitespace, Punctuation
                ),
                "#pop",
            ),
            ...
            (
                r"(cycle)(\s+)(?:([^\s:]*)(:))?(\s*)",
                bygroups(
                    Name.Tag, Whitespace, using(this, state="generic"), Punctuation, Whitespace
                ),
                "variable-tag-markup",
            ),
        ...
        "param-markup": [
            ...
            (
                r"(\{\{)(\s*)([^\s}])(\s*)(\}\})",
                bygroups(
                    Punctuation, Whitespace, using(this, state="variable"), Whitespace, Punctuation
                ),
            ),
            include("string"),
            include("number"),
