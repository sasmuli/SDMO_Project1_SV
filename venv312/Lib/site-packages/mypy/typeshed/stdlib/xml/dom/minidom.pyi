...
_NodesThatAreChildren: TypeAlias = (
    CDATASection | Comment | DocumentType | Element | Notation | ProcessingInstruction | Text
)
...
class NamedNodeMap:
    ...
    def __init__(
        self, attrs: dict[str, Attr], attrsNS: dict[_NSName, Attr], ownerElement: Element
    ) -> None: ...
    @property
    def length(self) -> int: ...
...
class Childless:
    ...
    def replaceChild(
        self, newChild: _NodesThatAreChildren | DocumentFragment, oldChild: _NodesThatAreChildren
    ) -> NoReturn: ...
...
class Entity(Identified, Node):
    ...
    def __init__(
        self, name: str, publicId: str | None, systemId: str | None, notation: str | None
    ) -> None: ...
