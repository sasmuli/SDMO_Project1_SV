...
df["apply"] = df["apply"].cat.set_categories(["unlikely", "somewhat likely", "very likely"])
...
res_ord_logit.prob_pred = np.array(
    [
        [0.5488310, 0.3593310, 0.09183798],
...
res_ord_probit.prob_pred = np.array(
    [
        [0.5514181, 0.3576848, 0.09089707],
...
res_ord_cloglog.prob_pred = np.array(
    [
        [0.5519526, 0.3592524, 0.08879500],
