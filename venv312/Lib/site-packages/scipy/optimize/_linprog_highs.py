...
def _highs_to_scipy_status_message(highs_status, highs_message):
    ...
    scipy_statuses_messages = {
        ...
        HighsModelStatus.kUnboundedOrInfeasible: (4, "The problem is unbounded " "or infeasible. "),
    }
...
def _linprog_highs(
    ...
    **unknown_options,
    ...
    res = _highs_wrapper(
        c, A.indptr, A.indices, A.data, lhs, rhs, lb, ub, integrality.astype(np.uint8), options
    )
