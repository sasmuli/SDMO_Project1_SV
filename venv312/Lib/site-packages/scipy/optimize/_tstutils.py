...
def fun9(x):
    xp = array_namespace(x)
    return xp.exp(x) - 2 - 0.01 / x**2 + 0.000002 / x**3
...
_CHANDRUPATLA_TESTS = [
    ...
    [fun6, [-1.0, 4.0], fun6.root, 21],
    [fun6, [-2.0, 5.0], fun6.root, 22],
    [fun6, [-1.0, 10.0], fun6.root, 23],
    [fun6, [-5.0, 50.0], fun6.root, 25],
    [fun6, [-10.0, 100.0], fun6.root, 26],
...
_CHANDRUPATLA_TESTS = [
    test + [f"{test[0].__name__}.{i%5+1}"] for i, test in enumerate(_CHANDRUPATLA_TESTS)
]

_CHANDRUPATLA_TESTS_DICTS = [
    dict(zip(_CHANDRUPATLA_TESTS_KEYS, testcase)) for testcase in _CHANDRUPATLA_TESTS
]
