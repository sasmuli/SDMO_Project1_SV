...
class FactorLexer(RegexLexer):
    ...
    builtin_strings = words(
        ("1string", "<string>", ">string", "resize-string", "string", "string?"), suffix=r"(\s+)"
    )

    builtin_vectors = words(
        ("1vector", "<vector>", ">vector", "?push", "vector", "vector?"), suffix=r"(\s+)"
    )
    ...
    tokens = {
        ...
        "base": [
            ...
            (
                ...
                bygroups(
                    Keyword, Whitespace, Name.Class, Whitespace, Punctuation, Whitespace, Name.Class
                ),
                "slots",
            ),
            (
        ...
        "slots": [
            ...
            (
                r"(\{)(\s+)(\S+)(\s+)([^}]+)(\s+)(\})(\s+)",
                bygroups(
                    Text, Whitespace, Name.Variable, Whitespace, Text, Whitespace, Text, Whitespace
                ),
            ),
            (r"\S+", Name.Variable),
        ],
