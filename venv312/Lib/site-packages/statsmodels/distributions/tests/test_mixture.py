...
class TestMixtureDistributions:
    ...
    def test_mixture_rvs_random(self):
        ...
        npt.assert_almost_equal(
            np.array([res.std(), res.mean(), res.var()]), np.array([1, -0.5, 1]), decimal=1
        )
    ...
    def test_mv_mixture_rvs_random(self):
        ...
        npt.assert_almost_equal(
            np.array([res.std(), res.mean(), res.var()]), np.array([1.874, 1.733, 3.512]), decimal=1
        )
    ...
    def test_mixture_pdf(self):
        ...
        res = mix.pdf(
            ...
            [1 / 3.0, 2 / 3.0],
            dist=[stats.norm, stats.norm],
            kwargs=(dict(loc=-1, scale=0.25), dict(loc=1, scale=0.75)),
        )
        npt.assert_almost_equal(
            res,
            np.array(
