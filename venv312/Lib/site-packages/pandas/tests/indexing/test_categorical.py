...
def df():
    return DataFrame(
        ...
        index=CategoricalIndex(list("aabbca"), dtype=CategoricalDtype(list("cab")), name="B"),
    )
...
def df2():
    return DataFrame(
        ...
        index=CategoricalIndex(list("aabbca"), dtype=CategoricalDtype(list("cabe")), name="B"),
    )
...
class TestCategoricalIndex:
    ...
    def test_loc_slice(self, df):
        # GH9748
        msg = (
            "cannot do slice indexing on CategoricalIndex with these " r"indexers \[1\] of type int"
        )
