...
class ECLexer(CLexer):
    ...
    tokens = {
        "statements": [
            ...
            (
                words(
                    ("uint", "uint16", "uint32", "uint64", "bool", "byte", "unichar", "int64"),
                    suffix=r"\b",
                ),
                Keyword.Type,
            ),
...
class PromelaLexer(CLexer):
    ...
    tokens = {
        ...
        "types": [
            ...
            (
                words(("bit", "bool", "byte", "pid", "short", "int", "unsigned"), suffix=r"\b"),
                Keyword.Type,
            ),
        ],
        "keywords": [
            ...
            # BasicStatements
            (
                words(("assert", "get_priority", "printf", "printm", "set_priority"), suffix=r"\b"),
                Name.Function,
            ),
            # Embedded C Code
            ...
            (
                words(
                    ("_", "_last", "_nr_pr", "_pid", "_priority", "else", "np_", "STDIN"),
                    suffix=r"\b",
                ),
                Name.Builtin,
            ),
            ...
            (
                words(
                    ("empty", "enabled", "eval", "full", "len", "nempty", "nfull", "pc_value"),
                    suffix=r"\b",
                ),
                Name.Function,
            ),
