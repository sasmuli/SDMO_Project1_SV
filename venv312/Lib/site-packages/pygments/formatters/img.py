...
class FontManager:
    ...
    def _get_nix_font_path(self, name, style):
        proc = subprocess.Popen(
            ["fc-list", f"{name}:style={style}", "file"], stdout=subprocess.PIPE, stderr=None
        )
...
class ImageFormatter(Formatter):
    ...
    def format(self, tokensource, outfile):
        ...
        im = Image.new(
            "RGB", self._get_image_size(self.maxlinelength, self.maxlineno), self.background_color
        )
        ...
        for pos, value, font, text_fg, text_bg in self.drawables:
            if text_bg:
                ...
                draw.rectangle(
                    [pos[0], pos[1], pos[0] + text_size[0], pos[1] + text_size[1]], fill=text_bg
                )
