...
class TestSphericalJn:
    ...
    def test_spherical_jn_recurrence_complex(self):
        ...
        x = 1.1 + 1.5j
        assert_allclose(
            spherical_jn(n - 1, x) + spherical_jn(n + 1, x), (2 * n + 1) / x * spherical_jn(n, x)
        )
...
class TestSphericalYn:
    ...
    def test_spherical_yn_recurrence_real(self):
        ...
        x = 0.12
        assert_allclose(
            spherical_yn(n - 1, x) + spherical_yn(n + 1, x), (2 * n + 1) / x * spherical_yn(n, x)
        )
...
class TestSphericalJnYnCrossProduct:
    def test_spherical_jn_yn_cross_product_1(self):
        ...
        n = np.array([1, 5, 8])
        x = np.array([0.1, 1, 10])
        left = spherical_jn(n + 1, x) * spherical_yn(n, x) - spherical_jn(n, x) * spherical_yn(
            n + 1, x
        )
        right = 1 / x**2
    ...
    def test_spherical_jn_yn_cross_product_2(self):
        ...
        n = np.array([1, 5, 8])
        x = np.array([0.1, 1, 10])
        left = spherical_jn(n + 2, x) * spherical_yn(n, x) - spherical_jn(n, x) * spherical_yn(
            n + 2, x
        )
        right = (2 * n + 3) / x**3
        assert_allclose(left, right)
...
class TestSphericalIn:
    ...
    def test_spherical_in_recurrence_real(self):
        ...
        x = 0.12
        assert_allclose(
            spherical_in(n - 1, x) - spherical_in(n + 1, x), (2 * n + 1) / x * spherical_in(n, x)
        )
...
class TestSphericalInDerivatives(SphericalDerivativesTestCase):
    ...
    def test_spherical_in_d_zero(self):
        ...
        assert_allclose(spherical_in(n, 0, derivative=True), np.array([0, 1 / 3, 0, 0, 0, 0]))
...
class TestSphericalOld:
    ...
    def test_sph_kn(self):
        ...
        assert_array_almost_equal(
            kn[0], [6.4302962978445670140, 38.581777787067402086, 585.15696310385559829], 12
        )
...
@pytest.mark.parametrize("fun", [spherical_jn, spherical_in, spherical_yn, spherical_kn])
