...
class Uniform(CustomKernel):
    def __init__(self, h=1.0):
        CustomKernel.__init__(
            self, shape=lambda x: 0.5 * np.ones(x.shape), h=h, domain=[-1.0, 1.0], norm=1.0
        )
        self._L2Norm = 0.5
...
class Epanechnikov(CustomKernel):
    def __init__(self, h=1.0):
        CustomKernel.__init__(
            self, shape=lambda x: 0.75 * (1 - x * x), h=h, domain=[-1.0, 1.0], norm=1.0
        )
        self._L2Norm = 0.6
...
class Biweight(CustomKernel):
    def __init__(self, h=1.0):
        CustomKernel.__init__(
            self, shape=lambda x: 0.9375 * (1 - x * x) ** 2, h=h, domain=[-1.0, 1.0], norm=1.0
        )
...
class Triweight(CustomKernel):
    def __init__(self, h=1.0):
        CustomKernel.__init__(
            self, shape=lambda x: 1.09375 * (1 - x * x) ** 3, h=h, domain=[-1.0, 1.0], norm=1.0
        )
...
class Gaussian(CustomKernel):
    ...
    def __init__(self, h=1.0):
        CustomKernel.__init__(
            self,
            shape=lambda x: 0.3989422804014327 * np.exp(-(x**2) / 2.0),
            h=h,
            domain=None,
            norm=1.0,
        )
...
class Cosine(CustomKernel):
    ...
    def __init__(self, h=1.0):
        CustomKernel.__init__(
            self,
            shape=lambda x: 0.78539816339744828 * np.cos(np.pi / 2.0 * x),
            h=h,
            domain=[-1.0, 1.0],
            norm=1.0,
        )
...
class Cosine2(CustomKernel):
    ...
    def __init__(self, h=1.0):
        CustomKernel.__init__(
            self, shape=lambda x: 1 + np.cos(2.0 * np.pi * x), h=h, domain=[-0.5, 0.5], norm=1.0
        )
        self._L2Norm = 1.5
...
class Tricube(CustomKernel):
    ...
    def __init__(self, h=1.0):
        CustomKernel.__init__(
            self,
            shape=lambda x: 0.864197530864 * (1 - abs(x) ** 3) ** 3,
            h=h,
            domain=[-1.0, 1.0],
            norm=1.0,
        )
