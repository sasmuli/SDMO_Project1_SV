...
class CheckModelResults(CheckModelMixin):
    ...
    @pytest.mark.xfail(
        reason="Test has not been implemented for this class.",
        strict=True,
    ...
    def test_predict_xb(self):
        assert_almost_equal(
            self.res1.model.predict(self.res1.params, which="linear"), self.res2.yhat, DECIMAL_4
        )
...
class CheckMargEff:
    ...
    def test_nodummy_dydxmedian(self):
        ...
        assert_almost_equal(me.margeff, self.res2.margeff_nodummy_dydxmedian, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_nodummy_dydxmedian_se, DECIMAL_4)

    def test_nodummy_dydxzero(self):
        me = self.res1.get_margeff(at="zero")
        assert_almost_equal(me.margeff, self.res2.margeff_nodummy_dydxzero, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_nodummy_dydxzero, DECIMAL_4)

    def test_nodummy_dyexoverall(self):
        me = self.res1.get_margeff(method="dyex")
        assert_almost_equal(me.margeff, self.res2.margeff_nodummy_dyex, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_nodummy_dyex_se, DECIMAL_4)

    def test_nodummy_dyexmean(self):
        me = self.res1.get_margeff(at="mean", method="dyex")
        assert_almost_equal(me.margeff, self.res2.margeff_nodummy_dyexmean, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_nodummy_dyexmean_se, DECIMAL_4)

    def test_nodummy_dyexmedian(self):
        me = self.res1.get_margeff(at="median", method="dyex")
        assert_almost_equal(me.margeff, self.res2.margeff_nodummy_dyexmedian, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_nodummy_dyexmedian_se, DECIMAL_4)

    def test_nodummy_dyexzero(self):
        me = self.res1.get_margeff(at="zero", method="dyex")
        assert_almost_equal(me.margeff, self.res2.margeff_nodummy_dyexzero, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_nodummy_dyexzero_se, DECIMAL_4)

    def test_nodummy_eydxoverall(self):
        me = self.res1.get_margeff(method="eydx")
        assert_almost_equal(me.margeff, self.res2.margeff_nodummy_eydx, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_nodummy_eydx_se, DECIMAL_4)

    def test_nodummy_eydxmean(self):
        me = self.res1.get_margeff(at="mean", method="eydx")
        assert_almost_equal(me.margeff, self.res2.margeff_nodummy_eydxmean, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_nodummy_eydxmean_se, DECIMAL_4)
    ...
    def test_nodummy_eydxmedian(self):
        ...
        assert_almost_equal(me.margeff_se, self.res2.margeff_nodummy_eydxmedian_se, DECIMAL_4)

    def test_nodummy_eydxzero(self):
        me = self.res1.get_margeff(at="zero", method="eydx")
        assert_almost_equal(me.margeff, self.res2.margeff_nodummy_eydxzero, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_nodummy_eydxzero_se, DECIMAL_4)

    def test_nodummy_eyexoverall(self):
        me = self.res1.get_margeff(method="eyex")
        assert_almost_equal(me.margeff, self.res2.margeff_nodummy_eyex, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_nodummy_eyex_se, DECIMAL_4)

    def test_nodummy_eyexmean(self):
        me = self.res1.get_margeff(at="mean", method="eyex")
        assert_almost_equal(me.margeff, self.res2.margeff_nodummy_eyexmean, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_nodummy_eyexmean_se, DECIMAL_4)

    def test_nodummy_eyexmedian(self):
        me = self.res1.get_margeff(at="median", method="eyex")
        assert_almost_equal(me.margeff, self.res2.margeff_nodummy_eyexmedian, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_nodummy_eyexmedian_se, DECIMAL_4)

    def test_nodummy_eyexzero(self):
        me = self.res1.get_margeff(at="zero", method="eyex")
        assert_almost_equal(me.margeff, self.res2.margeff_nodummy_eyexzero, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_nodummy_eyexzero_se, DECIMAL_4)

    def test_dummy_dydxoverall(self):
        me = self.res1.get_margeff(dummy=True)
        assert_almost_equal(me.margeff, self.res2.margeff_dummy_dydx, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_dummy_dydx_se, DECIMAL_4)

    def test_dummy_dydxmean(self):
        me = self.res1.get_margeff(at="mean", dummy=True)
        assert_almost_equal(me.margeff, self.res2.margeff_dummy_dydxmean, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_dummy_dydxmean_se, DECIMAL_4)

    def test_dummy_eydxoverall(self):
        me = self.res1.get_margeff(method="eydx", dummy=True)
        assert_almost_equal(me.margeff, self.res2.margeff_dummy_eydx, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_dummy_eydx_se, DECIMAL_4)

    def test_dummy_eydxmean(self):
        me = self.res1.get_margeff(at="mean", method="eydx", dummy=True)
        assert_almost_equal(me.margeff, self.res2.margeff_dummy_eydxmean, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_dummy_eydxmean_se, DECIMAL_4)

    def test_count_dydxoverall(self):
        me = self.res1.get_margeff(count=True)
        assert_almost_equal(me.margeff, self.res2.margeff_count_dydx, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_count_dydx_se, DECIMAL_4)

    def test_count_dydxmean(self):
        me = self.res1.get_margeff(count=True, at="mean")
        assert_almost_equal(me.margeff, self.res2.margeff_count_dydxmean, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_count_dydxmean_se, DECIMAL_4)

    def test_count_dummy_dydxoverall(self):
        me = self.res1.get_margeff(count=True, dummy=True)
        assert_almost_equal(me.margeff, self.res2.margeff_count_dummy_dydxoverall, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_count_dummy_dydxoverall_se, DECIMAL_4)

    def test_count_dummy_dydxmean(self):
        me = self.res1.get_margeff(count=True, dummy=True, at="mean")
        assert_almost_equal(me.margeff, self.res2.margeff_count_dummy_dydxmean, DECIMAL_4)
        assert_almost_equal(me.margeff_se, self.res2.margeff_count_dummy_dydxmean_se, DECIMAL_4)
...
class TestProbitNM(CheckBinaryResults):
    ...
    def setup_class(cls):
        ...
        res2 = Spector.probit
        cls.res2 = res2
        cls.res1 = Probit(data.endog, data.exog).fit(method="nm", disp=0, maxiter=500)
...
class TestProbitPowell(CheckBinaryResults):
    ...
    def setup_class(cls):
        ...
        res2 = Spector.probit
        cls.res2 = res2
        cls.res1 = Probit(data.endog, data.exog).fit(method="powell", disp=0, ftol=1e-8)
...
class TestProbitCG(CheckBinaryResults):
    ...
    def setup_class(cls):
        ...
        cls.res1 = Probit(data.endog, data.exog).fit(
            start_params=start_params, method="cg", maxiter=1000, gtol=1e-05, disp=0
        )
...
class TestProbitNCG(CheckBinaryResults):
    ...
    def setup_class(cls):
        ...
        cls.res2 = res2
        cls.res1 = Probit(data.endog, data.exog).fit(
            method="ncg", disp=0, avextol=1e-8, warn_convergence=False
        )
...
class TestProbitBasinhopping(CheckBinaryResults):
    ...
    def setup_class(cls):
        ...
        np.random.seed(1)
        cls.res1 = fit(
            method="basinhopping", disp=0, niter=5, minimizer={"method": "L-BFGS-B", "tol": 1e-8}
        )
...
class TestProbitMinimizeAdditionalOptions(CheckBinaryResults):
    ...
    def setup_class(cls):
        ...
        cls.res2 = res2
        cls.res1 = Probit(data.endog, data.exog).fit(
            method="minimize", disp=0, maxiter=500, min_method="Nelder-Mead", xatol=1e-4, fatol=1e-4
        )
...
class TestMNLogitL1(CheckLikelihoodModelL1):
    ...
    def setup_class(cls):
        ...
        alpha = 10.0 * np.ones((mlogit_mod.J - 1, mlogit_mod.K))  # / anes_exog.shape[0]
        alpha[-1, :] = 0
        cls.res1 = mlogit_mod.fit_regularized(
            method="l1", alpha=alpha, trim_mode="auto", auto_trim_tol=0.02, acc=1e-10, disp=0
        )
...
class TestLogitL1(CheckLikelihoodModelL1):
    ...
    def setup_class(cls):
        data = load_spector()
        data.exog = sm.add_constant(data.exog, prepend=True)
        cls.alpha = 3 * np.array([0.0, 1.0, 1.0, 1.0])  # / data.exog.shape[0]
...
@pytest.mark.skipif(not has_cvxopt, reason="Skipped test_cvxopt since cvxopt " "is not available")
class TestCVXOPT:
    ...
    def test_cvxopt_versus_slsqp(self):
        ...
        self.alpha = 3.0 * np.array([0, 1, 1, 1.0])  # / self.data.endog.shape[0]
        res_slsqp = Logit(self.data.endog, self.data.exog).fit_regularized(
            method="l1", alpha=self.alpha, disp=0, acc=1e-10, maxiter=1000, trim_mode="auto"
        )
...
class TestSweepAlphaL1:
    ...
    def setup_class(cls):
        ...
        cls.alphas = np.array(
            [[0.1, 0.1, 0.1, 0.1], [0.4, 0.4, 0.5, 0.5], [0.5, 0.5, 1, 1]]
        )  # / data.exog.shape[0]
    ...
    def test_sweep_alpha(self):
        for i in range(3):
            ...
            res2 = self.model.fit_regularized(
                method="l1", alpha=alpha, disp=0, acc=1e-10, trim_mode="off", maxiter=1000
            )
...
class CheckL1Compatability:
    ...
    def test_cov_params(self):
        ...
        assert_almost_equal(
            self.res_unreg.cov_params()[:m, :m], self.res_reg.cov_params()[:m, :m], DECIMAL_1
        )
...
class TestPoissonL1Compatability(CheckL1Compatability):
    ...
    def setup_class(cls):
        ...
        cls.res_reg = sm.Poisson(rand_data.endog, rand_exog).fit_regularized(
            method="l1", alpha=alpha, disp=False, acc=1e-10, maxiter=2000, trim_mode="auto"
        )
...
class TestNegativeBinomialGeoL1Compatability(CheckL1Compatability):
    ...
    def setup_class(cls):
        ...
        # Drop some columns and do an unregularized fit
        exog_no_PSI = rand_exog[:, : cls.m]
        mod_unreg = sm.NegativeBinomial(rand_data.endog, exog_no_PSI, loglike_method="geometric")
        cls.res_unreg = mod_unreg.fit(method="newton", disp=False)
        # Do a regularized fit with alpha, effectively dropping the last columns
        alpha = 10 * len(rand_data.endog) * np.ones(cls.kvars)
        alpha[: cls.m] = 0
        mod_reg = sm.NegativeBinomial(rand_data.endog, rand_exog, loglike_method="geometric")
        cls.res_reg = mod_reg.fit_regularized(
            method="l1", alpha=alpha, disp=False, acc=1e-10, maxiter=2000, trim_mode="auto"
        )
...
class TestLogitL1Compatability(CheckL1Compatability):
    ...
    def setup_class(cls):
        ...
        cls.res_reg = Logit(data.endog, data.exog).fit_regularized(
            method="l1", alpha=alpha, disp=0, acc=1e-15, maxiter=2000, trim_mode="auto"
        )
...
class CompareL11D(CompareL1):
    ...
    def test_tests(self):
        ...
        assert_almost_equal(
            self.res1.t_test(restrictmat).pvalue, self.res2.t_test(restrictmat).pvalue, DECIMAL_4
        )
        assert_almost_equal(
            self.res1.f_test(restrictmat).pvalue, self.res2.f_test(restrictmat).pvalue, DECIMAL_4
        )
...
class TestL1AlphaZeroLogit(CompareL11D):
    ...
    def test_converged(self):
        res = self.res1.model.fit_regularized(
            method="l1", alpha=0, disp=0, acc=1e-15, maxiter=1, trim_mode="auto", auto_trim_tol=0.01
        )
...
class TestL1AlphaZeroMNLogit(CompareL1):
    ...
    def setup_class(cls):
        ...
        cls.res2 = MNLogit(data.endog, data.exog).fit(
            disp=0, gtol=1e-15, method="bfgs", maxiter=1000
        )
...
class CheckNegBinMixin:
    ...
    @pytest.mark.xfail(
        reason="pvalues do not match, in some cases wrong size", strict=True, raises=AssertionError
    )
    def test_pvalues(self):
        assert_almost_equal(self.res1.pvalues, self.res2.pvalues, DECIMAL_4)
...
class TestNegativeBinomialNB2Newton(CheckNegBinMixin, CheckModelResults):
    ...
    def test_predict(self):
        assert_almost_equal(
            self.res1.predict()[:10], np.exp(self.res2.fittedvalues[:10]), DECIMAL_3
        )

    def test_predict_xb(self):
        assert_almost_equal(
            self.res1.predict(which="linear")[:10], self.res2.fittedvalues[:10], DECIMAL_3
        )
...
class TestNegativeBinomialNB2BFGS(CheckNegBinMixin, CheckModelResults):
    ...
    def setup_class(cls):
        ...
        cls.res1 = NegativeBinomial(data.endog, exog, "nb2").fit(
            method="bfgs", disp=0, maxiter=1000
        )
        res2 = RandHIE.negativebinomial_nb2_bfgs
        cls.res2 = res2
...
class TestNegativeBinomialNB1BFGS(CheckNegBinMixin, CheckModelResults):
    ...
    def setup_class(cls):
        data = load_randhie()
        exog = sm.add_constant(data.exog, prepend=False)
        cls.res1 = NegativeBinomial(data.endog, exog, "nb1").fit(method="bfgs", maxiter=100, disp=0)
        res2 = RandHIE.negativebinomial_nb1_bfgs
        cls.res2 = res2
...
class CheckMNLogitBaseZero(CheckModelResults):
    ...
    def test_endog_names(self):
        assert_equal(
            self.res1._get_endog_name(None, None)[1], ["y=1", "y=2", "y=3", "y=4", "y=5", "y=6"]
        )
    ...
    def test_pred_table(self):
        ...
        # table
        pred = [
            [126.0, 41.0, 2.0, 0.0, 0.0, 12.0, 19.0],
            [77.0, 73.0, 3.0, 0.0, 0.0, 15.0, 12.0],
            [37.0, 43.0, 2.0, 0.0, 0.0, 19.0, 7.0],
            [12.0, 9.0, 1.0, 0.0, 0.0, 9.0, 6.0],
            [19.0, 10.0, 2.0, 0.0, 0.0, 20.0, 43.0],
            [22.0, 25.0, 1.0, 0.0, 0.0, 31.0, 71.0],
            [9.0, 7.0, 1.0, 0.0, 0.0, 18.0, 140.0],
        ]
...
class TestGeneralizedPoisson_p2:
    ...
    def test_alpha(self):
        ...
        assert_allclose(self.res1.lnalpha_std_err, self.res2.lnalpha_std_err, atol=1e-5)

    def test_conf_int(self):
        assert_allclose(self.res1.conf_int(), self.res2.conf_int, atol=1e-3)
...
class TestGeneralizedPoisson_transparams:
    ...
    def setup_class(cls):
        data = load_randhie()
        data.exog = sm.add_constant(data.exog, prepend=False)
        cls.res1 = GeneralizedPoisson(data.endog, data.exog, p=2).fit(method="newton", disp=0)
        res2 = RandHIE.generalizedpoisson_gp2
        cls.res2 = res2
...
class TestGeneralizedPoisson_p1:
    ...
    def setup_class(cls):
        ...
        cls.res1 = GeneralizedPoisson(cls.data.endog, cls.data.exog, p=1).fit(
            method="newton", disp=0
        )

    def test_llf(self):
        poisson_llf = sm.Poisson(self.data.endog, self.data.exog).loglike(self.res1.params[:-1])
        genpoisson_llf = sm.GeneralizedPoisson(self.data.endog, self.data.exog, p=1).loglike(
    ...
    def test_score(self):
        ...
        genpoisson_score = sm.GeneralizedPoisson(self.data.endog, self.data.exog, p=1).score(
            list(self.res1.params[:-1]) + [0]
        )
    ...
    def test_hessian(self):
        ...
        genpoisson_score = sm.GeneralizedPoisson(self.data.endog, self.data.exog, p=1).hessian(
            list(self.res1.params[:-1]) + [0]
        )
    ...
    def test_fit_regularized(self):
        ...
        assert_allclose((self.res1.params[:-2] ** 2).mean(), 0.016580955543320779, rtol=1e-5)
        assert_allclose((res_reg1.params[:-2] ** 2).mean(), 0.016580734975068664, rtol=1e-4)
        assert_allclose((res_reg2.params[:-2] ** 2).mean(), 0.010672558641545994, rtol=1e-5)
        assert_allclose((res_reg3.params[:-2] ** 2).mean(), 0.00035544919793048415, rtol=1e-5)
...
class TestGeneralizedPoisson_underdispersion:
    ...
    def setup_class(cls):
        ...
        cls.res = model_gp.fit(method="nm", xtol=1e-6, maxiter=5000, maxfun=5000, disp=0)
    ...
    def test_mean_var(self):
        assert_allclose(self.res.predict().mean(), self.endog.mean(), atol=1e-1, rtol=1e-1)
    ...
    def test_predict_prob(self):
        ...
        pr2 = sm.distributions.genpoisson_p.pmf(
            np.arange(6)[:, None], res.predict(), res.params[-1], 1
        ).T
...
class TestNegativeBinomialPNB2Newton(CheckNegBinMixin, CheckModelResults):
    ...
    def test_conf_int(self):
        assert_allclose(self.res1.conf_int(), self.res2.conf_int, atol=1e-3, rtol=1e-3)

    def test_zstat(self):  # Low precision because Z vs. t
        assert_allclose(self.res1.pvalues[:-1], self.res2.pvalues, atol=5e-3, rtol=5e-3)
...
class TestNegativeBinomialPNB1Newton(CheckNegBinMixin, CheckModelResults):
    ...
    def test_predict(self):
        assert_allclose(
            self.res1.predict()[:10], np.exp(self.res2.fittedvalues[:10]), atol=1e-3, rtol=1e-3
        )

    def test_predict_xb(self):
        assert_allclose(
            self.res1.predict(which="linear")[:10],
...
class TestNegativeBinomialPNB2BFGS(CheckNegBinMixin, CheckModelResults):
    ...
    def setup_class(cls):
        data = load_randhie()
        exog = sm.add_constant(data.exog, prepend=False)
        cls.res1 = NegativeBinomialP(data.endog, exog, p=2).fit(method="bfgs", disp=0, maxiter=1000)
        res2 = RandHIE.negativebinomial_nb2_bfgs
        cls.res2 = res2
    ...
    def test_alpha(self):
        ...
        assert_allclose(self.res1.lnalpha_std_err, self.res2.lnalpha_std_err, atol=1e-5, rtol=1e-5)
    ...
    def test_fittedvalues(self):
        assert_allclose(
            self.res1.fittedvalues[:10], self.res2.fittedvalues[:10], atol=1e-4, rtol=1e-4
        )
...
class TestNegativeBinomialPNB1BFGS(CheckNegBinMixin, CheckModelResults):
    ...
    def test_bse(self):
        assert_allclose(self.res1.bse, self.res2.bse, atol=5e-3, rtol=5e-3)
    ...
    def test_llf(self):
        assert_allclose(self.res1.llf, self.res2.llf, atol=1e-3, rtol=1e-3)
    ...
    def test_lnalpha(self):
        assert_allclose(self.res1.lnalpha, self.res2.lnalpha, atol=1e-3, rtol=1e-3)
        assert_allclose(self.res1.lnalpha_std_err, self.res2.lnalpha_std_err, atol=1e-3, rtol=1e-3)

    def test_params(self):
        assert_allclose(self.res1.params, self.res2.params, atol=5e-2, rtol=5e-2)

    def test_conf_int(self):
        # the bse for alpha is not high precision from the hessian
        # approximation
        assert_allclose(self.res1.conf_int(), self.res2.conf_int, atol=5e-2, rtol=5e-2)

    def test_predict(self):
        assert_allclose(
            self.res1.predict()[:10], np.exp(self.res2.fittedvalues[:10]), atol=5e-3, rtol=5e-3
        )
...
class TestNegativeBinomialPPredictProb:
    ...
    def test_predict_prob_p1(self):
        ...
        assert_allclose(
            probs, nbinom.pmf(np.arange(8)[:, None], size, prob).T, atol=1e-2, rtol=1e-2
        )
...
class TestNegativeBinomialNB1Null(CheckNull):
    ...
    def setup_class(cls):
        ...
        cls.res_null = cls.model_null.fit(
            start_params=[8, 1000], method="bfgs", gtol=1e-08, maxiter=300, disp=0
        )
...
class TestNegativeBinomialNB2Null(CheckNull):
    ...
    def setup_class(cls):
        ...
        cls.res_null = cls.model_null.fit(
            start_params=[8, 0.5], method="bfgs", gtol=1e-06, maxiter=300, disp=0
        )
...
class TestNegativeBinomialNBP2Null(CheckNull):
    ...
    def setup_class(cls):
        ...
        cls.res_null = cls.model_null.fit(
            start_params=[8, 1], method="bfgs", gtol=1e-06, maxiter=300, disp=0
        )
        cls.start_params = np.array([8.07216448, 0.01087238, 0.44024134])
...
class TestGeneralizedPoissonNull(CheckNull):
    ...
    def setup_class(cls):
        ...
        cls.res_null = cls.model_null.fit(
            start_params=[8.4, 1], method="bfgs", gtol=1e-08, maxiter=300, disp=0
        )
