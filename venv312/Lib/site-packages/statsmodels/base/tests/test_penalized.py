...
class CheckPenalizedPoisson:
    ...
    def test_params_table(self):
        ...
        with warnings.catch_warnings():
            ...
            assert_allclose(
                res1.pvalues[self.exog_index], res2.pvalues, rtol=self.rtol, atol=self.atol
            )
    ...
    def test_numdiff(self):
        ...
        assert_allclose(
            res1.model.score(p, **kwds)[self.exog_index],
...
class TestPenalizedPoissonOracleHC(CheckPenalizedPoisson):
    ...
    def test_cov_type(self):
        ...
        cov_kwds = {
            "description": "Standard Errors are heteroscedasticity " "robust (HC0)",
            "adjust_df": False,
            "use_t": False,
            "scaling_factor": None,
        }
        ...
        params = np.array(
            [0.96817787574701109, 0.43674374940137434, 0.33096260487556745, 0.27415680046693747]
        )
        bse = np.array(
            [0.028126650444581985, 0.033099984564283147, 0.033184585514904545, 0.034282504130503301]
        )
...
class TestPenalizedPoissonOraclePenalized2(CheckPenalizedPoisson):
    ...
    def _initialize(cls):
        ...
        mod.penal.tau = 0.05
        cls.res1 = mod.fit(
            start_params=params_notrim * 0.5, method="bfgs", maxiter=100, trim=True, disp=0
        )
...
class TestPenalizedPoissonOraclePenalized2HC(CheckPenalizedPoisson):
    ...
    def _initialize(cls):
        ...
        sp2 = np.array([0.96817921, 0.43673551, 0.33096011, 0.27416614])
        cls.res2 = modp.fit(
            start_params=sp2 * 0.5, cov_type=cov_type, method="bfgs", maxiter=100, disp=0
        )
        ...
        mod.penal.tau = 0.05
        cls.res1 = mod.fit(
            start_params=params_notrim * 0.5,
            cov_type=cov_type,
            method="bfgs",
            maxiter=100,
            trim=True,
...
class TestPenalizedGLMBinomCountNoPenal(CheckPenalizedBinomCount):
    ...
    def _initialize(cls):
        ...
        mod.pen_weight = 0
        cls.res1 = mod.fit(
            method="bfgs", max_start_irls=3, maxiter=100, disp=0, start_params=cls.res2.params * 0.9
        )
    ...
    def test_deriv(self):
        ...
        res2 = self.res2
        assert_allclose(
            res1.model.score(res2.params * 0.98), res2.model.score(res2.params * 0.98), rtol=1e-10
        )
        assert_allclose(
            res1.model.score_obs(res2.params * 0.98),
            res2.model.score_obs(res2.params * 0.98),
            rtol=1e-10,
        )
...
class TestPenalizedGLMBinomCountOracleHC2(CheckPenalizedBinomCount):
    ...
    def _initialize(cls):
        ...
        mod.penal.tau = 0.05
        cls.res1 = mod.fit(
            cov_type=cov_type, method="bfgs", max_start_irls=0, maxiter=100, disp=0, trim=0.001
        )
...
class TestPenalizedGLMGaussianL2(CheckPenalizedGaussian):
    ...
    def _initialize(cls):
        ...
        mod = GLMPenalized(
            y, x, family=family.Gaussian(), penal=smpen.L2ConstraintsPenalty(weights=weights)
        )
...
class TestPenalizedGLMGaussianL2Theil(CheckPenalizedGaussian):
    ...
    def test_params_table(self):
        ...
        assert_allclose(res1.tvalues[exog_index], res2.tvalues[exog_index], rtol=0.08, atol=5e-3)
        assert_allclose(res1.pvalues[exog_index], res2.pvalues[exog_index], rtol=0.1, atol=5e-3)
