...
class CheckResults:
    ...
    @pytest.mark.xfail(raises=AssertionError, reason="Occasional failure", strict=False)
...
class TestTruncatedLFPoisson_predict:
    ...
    def test_mean(self):
        assert_allclose(self.res.predict().mean(), self.endog.mean(), atol=2e-1, rtol=2e-1)
...
class TestHurdlePoissonR:
    ...
    def test_predict(self):
        ...
        assert_allclose(mnz, res2.predict_mean / (1 - res2.predict_prob[0]), rtol=5e-7, atol=5e-7)
