...
class ZstdCompressor:
    ...
    def compress(
        ...
        /,
        data: ReadableBuffer,
        mode: _ZstdCompressorContinue | _ZstdCompressorFlushBlock | _ZstdCompressorFlushFrame = 0,
    ) -> bytes: ...
    def flush(
    ...
    def last_mode(
        self,
    ) -> _ZstdCompressorContinue | _ZstdCompressorFlushBlock | _ZstdCompressorFlushFrame: ...

@final
class ZstdDecompressor:
    def __new__(
        cls, zstd_dict: ZstdDict | None = None, options: Mapping[int, int] | None = None
    ) -> Self: ...
...
def finalize_dict(
    custom_dict_bytes: bytes,
    samples_bytes: bytes,
    samples_sizes: tuple[int, ...],
    dict_size: int,
...
def set_parameter_types(
    c_parameter_type: type[CompressionParameter], d_parameter_type: type[DecompressionParameter]
) -> None: ...
def train_dict(
    samples_bytes: bytes, samples_sizes: tuple[int, ...], dict_size: int, /
) -> bytes: ...
