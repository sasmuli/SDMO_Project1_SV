...
def test_subset_loc_rows_columns(
    ...
    mutate_parent = (
        ...
        and (
            using_array_manager
            or (dtype == "int64" and dtype_backend == "numpy" and not using_copy_on_write)
        )
    )
...
def test_subset_set_with_column_indexer(backend, indexer, using_copy_on_write, warn_copy_on_write):
...
def test_getitem_midx_slice(using_copy_on_write, warn_copy_on_write, using_array_manager):
