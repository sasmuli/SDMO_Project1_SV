...
class StReader(CodeReader, StCommentsMixin):
    ...
    _functions = set(["FUNCTION_BLOCK", "FUNCTION", "ACTION"])
    ...
    # Nesting Depth
    loops = ["if", "case", "for", "while", "repeat", "IF", "CASE", "FOR", "WHILE", "REPEAT"]
    bracket = "END"

    def __init__(self, context):
        super(StReader, self).__init__(context)
        self.parallel_states = (StStates(context, self),)
    ...
    def generate_tokens(source_code, addition="", token_class=None):
        ...
        addition = (
            ...
            r"XOR|"
            r"NOT|"
            r"ELSE\s+IF|" + block_endings + addition
        )
...
class StStates(CodeStateMachine):
    ...
    def _state_global(self, token):
        ...
        if (
            token_upper in StReader._functions
            and self.context.current_function.top_nesting_level < 0
        ):
