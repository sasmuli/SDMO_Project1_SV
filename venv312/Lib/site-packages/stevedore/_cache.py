...
def _get_cache_dir():
    ...
    if os.name == "posix" and sys.platform != "darwin":
        ...
        base_path = os.environ.get("XDG_CACHE_HOME", None) or os.path.expanduser("~/.cache")
    ...
    # Windows (hopefully)
        ...
        base_path = os.environ.get("LOCALAPPDATA", None) or os.path.expanduser("~\\AppData\\Local")
...
class Cache:
    ...
    def __init__(self, cache_dir=None):
        ...
        if any(
            [os.path.isfile(os.path.join(self._dir, ".disable")), sys.executable[0:4] == "/tmp"]
        ):  # nosec B108
