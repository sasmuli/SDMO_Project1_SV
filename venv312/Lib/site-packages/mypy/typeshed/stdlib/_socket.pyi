...
class socket:
    ...
    if sys.platform == "win32":
        def __init__(
            ...
            type: int = ...,
            proto: int = ...,
            fileno: SupportsIndex | bytes | None = None,
        ) -> None: ...
    else:
        def __init__(
            self,
            ...
            type: int = ...,
            proto: int = ...,
            fileno: SupportsIndex | None = None,
        ) -> None: ...
    ...
    def recvfrom_into(
        self, buffer: WriteableBuffer, nbytes: int = 0, flags: int = 0
...
def getaddrinfo(
    ...
    tuple[int, int, int, str, tuple[str, int] | tuple[str, int, int, int] | tuple[int, bytes]]
]: ...
...
def getnameinfo(
    sockaddr: tuple[str, int] | tuple[str, int, int, int] | tuple[int, bytes], flags: int, /
) -> tuple[str, str]: ...
