...
class ExpatParser(xmlreader.IncrementalParser, xmlreader.Locator):
    ...
    if sys.version_info >= (3, 10):
        @overload
        def getProperty(
            self, name: Literal["http://xml.org/sax/properties/lexical-handler"]
        ) -> LexicalHandler | None: ...

    @overload
    def getProperty(
        self, name: Literal["http://www.python.org/sax/properties/interning-dict"]
    ) -> dict[str, Any] | None: ...
    @overload
    def getProperty(
        self, name: Literal["http://xml.org/sax/properties/xml-string"]
    ) -> bytes | None: ...
    @overload
    ...
    if sys.version_info >= (3, 10):
        ...
        def setProperty(
            self,
            name: Literal["http://xml.org/sax/properties/lexical-handler"],
            value: LexicalHandler,
        ) -> None: ...

    @overload
    def setProperty(
        self,
        name: Literal["http://www.python.org/sax/properties/interning-dict"],
        value: dict[str, Any],
    ) -> None: ...
    @overload
    ...
    def external_entity_ref(
        self, context: str, base: str | None, sysid: str, pubid: str | None
    ) -> int: ...
