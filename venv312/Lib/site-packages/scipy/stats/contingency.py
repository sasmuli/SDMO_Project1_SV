...
def _chi2_permutation_method(observed, expected, method):
    ...
    return stats.permutation_test(
        (x,), statistic, permutation_type="pairings", alternative="greater", **method._asdict()
    )
...
def _chi2_monte_carlo_method(observed, expected, method):
    ...
    return stats.monte_carlo_test(observed.ravel(), rvs, statistic, alternative="greater", **method)
