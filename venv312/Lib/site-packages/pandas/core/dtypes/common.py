...
def is_integer_dtype(arr_or_dtype) -> bool:
    ...
    False
    """
    return _is_dtype_type(arr_or_dtype, _classes_and_not_datetimelike(np.integer)) or _is_dtype(
...
def is_signed_integer_dtype(arr_or_dtype) -> bool:
    ...
    ) or _is_dtype(arr_or_dtype, lambda typ: isinstance(typ, ExtensionDtype) and typ.kind == "i")
...
def is_unsigned_integer_dtype(arr_or_dtype) -> bool:
    ...
    ) or _is_dtype(arr_or_dtype, lambda typ: isinstance(typ, ExtensionDtype) and typ.kind == "u")
...
def is_numeric_dtype(arr_or_dtype) -> bool:
    ...
    ) or _is_dtype(arr_or_dtype, lambda typ: isinstance(typ, ExtensionDtype) and typ._is_numeric)
