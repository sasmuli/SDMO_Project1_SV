    ...
    tokens = {
        ...
        "types": [
            ...
            (
                ...
                bygroups(
                    Keyword, Whitespace, Name.Class, Whitespace, Operator, Whitespace, Keyword.Type
                ),
            ),
            (
...
class SnowballLexer(ExtendedRegexLexer):
    ...
    def _stringescapes(lexer, match, ctx):
        ...
        return bygroups(Keyword.Reserved, Whitespace, String.Escape, Whitespace, String.Escape)(
            lexer, match, ctx
        )
    ...
    tokens = {
        ...
        "root1": [
            ...
            (
                words(
                    ("as", "get", "hex", "among", "define", "decimal", "backwardmode"), suffix=r"\b"
                ),
                Keyword.Reserved,
            ),
            (
                words(
                    ("strings", "booleans", "integers", "routines", "externals", "groupings"),
                    suffix=r"\b",
                ),
                Keyword.Reserved,
                "declaration",
