...
descriptions = {
    ...
    "approx": "Covariance matrix calculated using numerical ({approx_type}) " "differentiation.",
    "OPG": "Covariance matrix calculated using the outer product of " "gradients ({approx_type}).",
