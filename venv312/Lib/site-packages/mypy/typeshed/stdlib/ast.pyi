...
if sys.version_info >= (3, 10):
    ...
    _ConstantValue: typing_extensions.TypeAlias = (
...
class Constant(expr):
    ...
    def __init__(
        self, value: _ConstantValue, kind: str | None = None, **kwargs: Unpack[_Attributes]
    ) -> None: ...
...
class Name(expr):
    ...
    if sys.version_info >= (3, 14):
        def __replace__(
            self, *, id: str = ..., ctx: expr_context = ..., **kwargs: Unpack[_Attributes]
        ) -> Self: ...
...
class keyword(AST):
    ...
    @overload
    def __init__(
        self, arg: str | None = None, *, value: expr, **kwargs: Unpack[_Attributes]
    ) -> None: ...

    if sys.version_info >= (3, 14):
        def __replace__(
            self, *, arg: str | None = ..., value: expr = ..., **kwargs: Unpack[_Attributes]
        ) -> Self: ...
...
class alias(AST):
    ...
    if sys.version_info >= (3, 10):
        def __init__(
            self, name: str, asname: str | None = None, **kwargs: Unpack[_Attributes]
        ) -> None: ...
    else:
    ...
    if sys.version_info >= (3, 14):
        def __replace__(
            self, *, name: str = ..., asname: str | None = ..., **kwargs: Unpack[_Attributes]
        ) -> Self: ...
...
if sys.version_info >= (3, 10):
    ...
    class match_case(AST):
        ...
        if sys.version_info >= (3, 13):
            def __init__(
                self, pattern: ast.pattern, guard: expr | None = None, body: list[stmt] = ...
            ) -> None: ...
        elif sys.version_info >= (3, 10):
            @overload
            def __init__(
                self, pattern: ast.pattern, guard: expr | None, body: list[stmt]
            ) -> None: ...
            @overload
            def __init__(
                self, pattern: ast.pattern, guard: expr | None = None, *, body: list[stmt]
    ...
    class MatchSingleton(pattern):
        ...
        if sys.version_info >= (3, 14):
            def __replace__(
                self, *, value: bool | None = ..., **kwargs: Unpack[_Attributes[int]]
            ) -> Self: ...
    ...
    class MatchStar(pattern):
        ...
        if sys.version_info >= (3, 14):
            def __replace__(
                self, *, name: str | None = ..., **kwargs: Unpack[_Attributes[int]]
            ) -> Self: ...
...
if sys.version_info >= (3, 12):
    ...
    class TypeVar(type_param):
        ...
        if sys.version_info >= (3, 13):
            ...
            def __init__(
                self, name: str, bound: expr | None = None, **kwargs: Unpack[_Attributes[int]]
            ) -> None: ...
