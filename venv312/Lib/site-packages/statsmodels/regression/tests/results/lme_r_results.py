...
vcov_ml_drf_2 = np.array([0.00117849, 1.458744e-05, 1.458744e-05, 0.001054926]).reshape(
    2, 2, order="F"
)
...
vcov_reml_drf_2 = np.array([0.001190455, 1.482666e-05, 1.482666e-05, 0.001066002]).reshape(
    2, 2, order="F"
)
...
vcov_ml_drf_3 = np.array([0.01398831, 0.001592619, 0.001592619, 0.01602274]).reshape(
    2, 2, order="F"
)
...
vcov_reml_drf_3 = np.array([0.01411922, 0.001607343, 0.001607343, 0.01617574]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_ml_drf_6 = np.array([0.2420741, 0.2222169, 0.2222169, 0.4228908]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_reml_drf_6 = np.array([0.2421365, 0.2221108, 0.2221108, 0.4244443]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_ml_drf_7 = np.array([0.1823183, 0.02247519, 0.02247519, 1.125011]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_reml_drf_7 = np.array([0.1828266, 0.02229138, 0.02229138, 1.128947]).reshape(
    2, 2, order="F"
)
...
vcov_ml_drf_8 = np.array([0.002491643, 0.0001693531, 0.0001693531, 0.00253309]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_ml_drf_8 = np.array([0.05400391, 0.002330104, 0.002330104, 0.122761]).reshape(
    2, 2, order="F"
)

coef_reml_drf_8 = np.array([-1.083938, 0.8956893])

vcov_reml_drf_8 = np.array([0.002528969, 0.0001712206, 0.0001712206, 0.002573335]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_reml_drf_8 = np.array([0.05463632, 0.002393538, 0.002393538, 0.1249828]).reshape(
    2, 2, order="F"
)

coef_ml_irf_8 = np.array([-1.079481, 0.898216])

vcov_ml_irf_8 = np.array([0.002511536, 0.0001812511, 0.0001812511, 0.002573405]).reshape(
    2, 2, order="F"
)
...
vcov_reml_irf_8 = np.array([0.002549354, 0.0001833386, 0.0001833386, 0.002614672]).reshape(
    2, 2, order="F"
)
...
vcov_ml_drf_9 = np.array([0.02208544, 0.001527479, 0.001527479, 0.02597528]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_ml_drf_9 = np.array([0.3994872, 0.02478884, 0.02478884, 1.195077]).reshape(
    2, 2, order="F"
)

coef_reml_drf_9 = np.array([-1.272483, 0.861814])

vcov_reml_drf_9 = np.array([0.02228589, 0.001535598, 0.001535598, 0.0262125]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_reml_drf_9 = np.array([0.401762, 0.02521271, 0.02521271, 1.203536]).reshape(
    2, 2, order="F"
)

coef_ml_irf_9 = np.array([-1.277018, 0.86395])

vcov_ml_irf_9 = np.array([0.02205706, 0.001509887, 0.001509887, 0.02599941]).reshape(
    2, 2, order="F"
)
...
vcov_reml_irf_9 = np.array([0.02225705, 0.001517774, 0.001517774, 0.02623682]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_ml_drf_10 = np.array([0.1988816, 0.1872403, 0.1872403, 0.4052274]).reshape(
    2, 2, order="F"
)
...
cov_re_reml_drf_10 = np.array([0.2034827, 0.09063836, 0.09063836, 2.219191]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_reml_drf_10 = np.array([0.1983981, 0.1865469, 0.1865469, 0.4100937]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_ml_drf_11 = np.array([0.2987928, 0.1992074, 0.1992074, 0.7477486]).reshape(
    2, 2, order="F"
)
...
ranef_condvar_reml_drf_11 = np.array([0.2965372, 0.2010191, 0.2010191, 0.7503986]).reshape(
    2, 2, order="F"
)
