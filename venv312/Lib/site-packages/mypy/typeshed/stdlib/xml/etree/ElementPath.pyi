...
_Callback: TypeAlias = Callable[
    [_SelectorContext, Iterable[Element]], Generator[Element, None, None]
]
_T = TypeVar("_T")
...
@overload
def iterfind(
    elem: Element[Any], path: str, namespaces: dict[str, str] | None = None
...
@overload
def findtext(
    elem: Element[Any], path: str, default: None = None, namespaces: dict[str, str] | None = None
) -> str | None: ...
@overload
def findtext(
    elem: Element[Any], path: str, default: _T, namespaces: dict[str, str] | None = None
) -> _T | str: ...
