...
def test_incidence():
    ...
    cinc = [
        ...
        np.array([0.0, 0.0, 0.20740741, 0.20740741, 0.20740741, 0.20740741, 0.20740741]),
    ...
    cinc_se = [
        ...
        np.array([0.0, 0.0, 0.10610391, 0.10610391, 0.10610391, 0.10610391, 0.10610391]),
...
def test_survfunc_entry_1():
    ...
    assert_allclose(
        sf.surv_prob, np.r_[0.5000, 0.4167, 0.3241, 0.2778, 0.2222, 0.1481, 0.0741], atol=1e-4
    )
    assert_allclose(
        sf.surv_prob_se, np.r_[0.3536, 0.3043, 0.2436, 0.2132, 0.1776, 0.1330, 0.0846], atol=1e-4
    )
