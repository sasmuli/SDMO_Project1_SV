...
def test_noncent_chi2():
    ...
    assert_allclose(stats.ncx2.cdf(chi2_stat, df, res.confint), [0.975, 0.025], rtol=1e-8)
...
def test_noncent_f():
    ...
    assert_allclose(stats.ncf.cdf(f_stat, df1, df2, res.confint), [0.975, 0.025], rtol=5e-5)
