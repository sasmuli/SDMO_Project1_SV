...
def fit(
    dist, data, bounds=None, *, guess=None, method="mle", optimizer=optimize.differential_evolution
):
...
def goodness_of_fit(
    ...
    *observed data*. This tends to reduce the value of the statistic for the
    ...
    return GoodnessOfFitResult(
        FitResult(dist, data, False, opt_res), res.statistic, res.pvalue, res.null_distribution
    )
...
def _gof_iv(dist, data, known_params, fit_params, guessed_params, statistic, n_mc_samples, rng):
