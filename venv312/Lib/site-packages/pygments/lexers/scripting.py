...
class ChaiscriptLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (r"[=+\-*/]", Operator),
            (
                r"(for|in|while|do|break|return|continue|if|else|" r"throw|try|catch" r")\b",
                Keyword,
                "slashstartsregex",
            ),
...
class HybrisLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"(extends|private|protected|public|static|throws|function|method|" r"operator)\b",
                Keyword.Declaration,
            ),
            (
                r"(true|false|null|__FILE__|__LINE__|__VERSION__|__LIB_PATH__|" r"__INC_PATH__)\b",
                Keyword.Constant,
            ),
    ...
    tokens = {
        "root": [
            ...
            (
                ...
                bygroups(
                    Name.Function, Whitespace, Operator, Whitespace, Keyword.Declaration, Whitespace
                ),
            ),
