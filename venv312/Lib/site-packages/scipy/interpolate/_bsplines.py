...
class BSpline:
    ...
    **Implementation details**
    ...
    def __call__(self, x, nu=0, extrapolate=None):
        ...
        _dierckx.evaluate_spline(
            self.t, cc.reshape(cc.shape[0], -1), self.k, x, nu, extrapolate, out.view(float)
        )
    ...
    def integrate(self, a, b, extrapolate=None):
        ...
        if extrapolate == "periodic":
            ...
            if n_periods > 0:
                ...
                _dierckx.evaluate_spline(ta, ca.reshape(ca.shape[0], -1), ka, x, 0, False, out)
            ...
            # Evaluate the difference of antiderivatives.
            x = np.asarray([a, b], dtype=np.float64)
            _dierckx.evaluate_spline(ta, ca.reshape(ca.shape[0], -1), ka, x, 0, extrapolate, out)
            integral = out[1] - out[0]
