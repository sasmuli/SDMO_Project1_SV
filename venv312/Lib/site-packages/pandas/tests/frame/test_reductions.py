...
def test_frame_mixed_numeric_object_with_timestamp(ts_value):
    ...
    with pytest.raises(TypeError, match="does not support (operation|reduction)|Cannot perform"):
        df.sum()
...
def test_fails_on_non_numeric(kernel):
    ...
    if kernel == "median":
        ...
        msg2 = (
            r"Cannot convert \[<class 'object'> <class 'object'> " r"<class 'object'>\] to numeric"
        )
        msg = "|".join([msg1, msg2])
    with pytest.raises(TypeError, match=msg):
