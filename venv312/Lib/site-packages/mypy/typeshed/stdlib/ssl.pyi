...
if sys.version_info < (3, 12):
    @deprecated(
        "Deprecated since Python 3.7; removed in Python 3.12. Use `SSLContext.wrap_socket()` instead."
    )
    def wrap_socket(
        sock: socket.socket,
...
ALERT_DESCRIPTION_BAD_CERTIFICATE_HASH_VALUE: Final = (
    AlertDescription.ALERT_DESCRIPTION_BAD_CERTIFICATE_HASH_VALUE
)
ALERT_DESCRIPTION_BAD_CERTIFICATE_STATUS_RESPONSE: Final = (
    AlertDescription.ALERT_DESCRIPTION_BAD_CERTIFICATE_STATUS_RESPONSE
)
ALERT_DESCRIPTION_BAD_RECORD_MAC: Final = AlertDescription.ALERT_DESCRIPTION_BAD_RECORD_MAC
ALERT_DESCRIPTION_CERTIFICATE_EXPIRED: Final = (
    AlertDescription.ALERT_DESCRIPTION_CERTIFICATE_EXPIRED
)
ALERT_DESCRIPTION_CERTIFICATE_REVOKED: Final = (
    AlertDescription.ALERT_DESCRIPTION_CERTIFICATE_REVOKED
)
ALERT_DESCRIPTION_CERTIFICATE_UNKNOWN: Final = (
    AlertDescription.ALERT_DESCRIPTION_CERTIFICATE_UNKNOWN
)
ALERT_DESCRIPTION_CERTIFICATE_UNOBTAINABLE: Final = (
    AlertDescription.ALERT_DESCRIPTION_CERTIFICATE_UNOBTAINABLE
)
...
ALERT_DESCRIPTION_DECOMPRESSION_FAILURE: Final = (
...
ALERT_DESCRIPTION_INSUFFICIENT_SECURITY: Final = (
...
ALERT_DESCRIPTION_UNKNOWN_PSK_IDENTITY: Final = (
    AlertDescription.ALERT_DESCRIPTION_UNKNOWN_PSK_IDENTITY
)
ALERT_DESCRIPTION_UNRECOGNIZED_NAME: Final = AlertDescription.ALERT_DESCRIPTION_UNRECOGNIZED_NAME
ALERT_DESCRIPTION_UNSUPPORTED_CERTIFICATE: Final = (
    AlertDescription.ALERT_DESCRIPTION_UNSUPPORTED_CERTIFICATE
)
ALERT_DESCRIPTION_UNSUPPORTED_EXTENSION: Final = (
