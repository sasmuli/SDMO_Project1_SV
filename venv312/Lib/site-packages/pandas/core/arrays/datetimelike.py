...
class DatetimeLikeArrayMixin(OpsMixin, NDArrayBackedExtensionArray):  # type: ignore[misc]
    """
    ...
    def _add_nat(self):
        ...
        return type(self)._simple_new(result, dtype=self.dtype, freq=None)  # type: ignore[arg-type]
