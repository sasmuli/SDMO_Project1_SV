...
right_all = (
    categ2[("0", "open")] + categ2[("0", "finite")] + categ2[("finite", "open")] + right_incorrect
)
...
if __name__ == "__main__":
    ...
    for i in range(1):
        ...
        rvs_orig = np.hstack(
            (rvs_orig, stats.halflogistic.rvs(loc=0.4, scale=5.0, size=n * (1 - convol)))
        )
        ...
        for distname in targetdist:
            ...
            # args = tuple()
            results.append(
                [distname, ks_stat, ks_pval, arg_est, loc_est, scale_est, crit, tail_prob]
            )
