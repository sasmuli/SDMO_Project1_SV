...
class Huber:
    ...
    def __init__(self):
        ...
        self.bcov_unscaled = np.array(
            [
                [1.72887367e-03, -3.47079127e-03, -6.79080082e-04, 2.73387119e-02],
                [-3.47079127e-03, 1.28754242e-02, 9.95952051e-07, -6.19611175e-02],
                [-6.79080082e-04, 9.95952051e-07, 2.32216722e-03, -1.59355028e-01],
                [2.73387119e-02, -6.19611175e-02, -1.59355028e-01, 1.34527267e01],
            ]
        )  # From R
...
class Andrews:
    def __init__(self):
        self.params = [0.9282, 0.6492, -0.1123, -42.2930]
    ...
    def conf_int(self):  # method to be consistent with sm
        return [(0.7203, 1.1360), (0.0819, 1.2165), (-0.3532, 0.1287), (-60.6305, -23.9555)]
...
class HuberHuber:
    def __init__(self):
        ...
        self.params = (0.7990, 1.0475, -0.1351, -41.0892)
        self.bse = (0.1213, 0.3310, 0.1406, 10.7002)
        self.scale = 3.2946
        self.df_model = 3
        self.df_resid = 17
...
class BisquareHuber:
    ...
    def conf_int(self):
        return [(0.5399, 1.0465), (0.3565, 1.7389), (-0.4271, 0.1600), (-63.2381, -18.5517)]
...
class AndrewsHuber:
    ...
    def conf_int(self):
        return [(0.5395, 1.0460), (0.3575, 1.7397), (-0.4271, 0.1599), (-63.2213, -18.5423)]
