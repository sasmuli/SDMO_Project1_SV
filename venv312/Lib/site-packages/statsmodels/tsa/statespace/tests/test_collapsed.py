...
class Trivariate:
    ...
    def test_forecasts_error_cov(self):
        assert_allclose(
            self.results_a.forecasts_error_cov[0, 0, :], self.results_b.forecasts_error_cov[0, 0, :]
        )
    ...
    def test_smoothed_states_cov(self):
        assert_allclose(
            self.results_a.smoothed_state_cov, self.results_b.smoothed_state_cov, atol=1e-4
        )

    def test_smoothed_states_autocov(self):
        assert_allclose(
            self.results_a.smoothed_state_autocov, self.results_b.smoothed_state_autocov
        )
    ...
    def test_smoothed_state_disturbance(self):
        assert_allclose(
            self.results_a.smoothed_state_disturbance, self.results_b.smoothed_state_disturbance
        )
    ...
    def test_simulation_smoothed_state_disturbance(self):
        assert_allclose(
            self.sim_a.simulated_state_disturbance, self.sim_a.simulated_state_disturbance
        )
...
class TestDFM:
    ...
    def setup_class(cls, which="mixed", *args, **kwargs):
        ...
        cls.sim_b = cls.model.simulation_smoother()
        cls.sim_b.simulate(
            measurement_disturbance_variates=mdv,
    ...
    def test_smoothed_states_autocov(self):
        ...
        assert_allclose(
            self.results_a.smoothed_state_autocov[:, :, 0:5],
            self.augmented_results.smoothed_state_cov[:2, 2:, 1:6],
            atol=1e-4,
        )
        assert_allclose(
            self.results_a.smoothed_state_autocov[:, :, 5:-1],
    ...
    def test_simulation_smoothed_state_disturbance(self):
        assert_allclose(
            self.sim_a.simulated_state_disturbance, self.sim_b.simulated_state_disturbance
        )
...
class TestDFMMeasurementDisturbance(TestDFM):
    ...
    def test_simulation_smoothed_measurement_disturbance(self):
        assert_allclose(
            ...
            self.sim_b.simulated_measurement_disturbance.T,
            atol=1e-7,
        )
