        ...
        if isinstance(path, str):
            ...
            if structure is UFOFileStructure.ZIP:
                ...
                if len(rootDirs) == 1:
                    ...
                    self.fs: FS = parentFS.opendir(rootDirs[0], factory=fs.subfs.ClosingSubFS)
                else:
...
class UFOWriter(UFOReader):
    ...
    def writeGroups(self, groups: KerningGroups, validate: Optional[bool] = None) -> None:
        """
    ...
    def writeKerning(self, kerning: KerningDict, validate: Optional[bool] = None) -> None:
        """
