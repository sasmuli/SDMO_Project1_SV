...
@overload
def vstack(
    tup: Sequence[_ArrayLike[_ScalarT]], *, dtype: None = ..., casting: _CastingKind = ...
) -> NDArray[_ScalarT]: ...
@overload
def vstack(
    tup: Sequence[ArrayLike], *, dtype: _DTypeLike[_ScalarT], casting: _CastingKind = ...
) -> NDArray[_ScalarT]: ...
@overload
def vstack(
    tup: Sequence[ArrayLike], *, dtype: DTypeLike = ..., casting: _CastingKind = ...
) -> NDArray[Any]: ...
@overload
def hstack(
    tup: Sequence[_ArrayLike[_ScalarT]], *, dtype: None = ..., casting: _CastingKind = ...
