...
class ContributorsCount(ProcessMetric):
    ...
    * Minor Contributors Count: measures the number of contributors who
    ...
    def __init__(
        ...
        super().__init__(
            path_to_repo, since=since, to=to, from_commit=from_commit, to_commit=to_commit
        )
        self._initialize()
    ...
    def _initialize(self):
        ...
        for commit in self.repo_miner.traverse_commits():
            ...
            for modified_file in commit.modified_files:
                ...
                self.contributors[filepath][author] = (
                    self.contributors[filepath].get(author, 0) + lines_authored
                )
        ...
        for path, contributions in list(self.contributors.items()):
            ...
            if total == 0:
                ...
                minor_contributors_count = sum(
                    1 for v in contributions.values() if v / total < 0.05
                )
