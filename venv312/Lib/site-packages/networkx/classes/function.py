    ...
    if data is True:
        if G.is_multigraph():
            if keys is True:
                ...
                return (
                    (n, n, d) for n, nbrs in G._adj.items() if n in nbrs for d in nbrs[n].values()
                )
        else:
        ...
        if G.is_multigraph():
            ...
            return ((n, n, nbrs[n].get(data, default)) for n, nbrs in G._adj.items() if n in nbrs)
    else:
        if G.is_multigraph():
            if keys is True:
                return ((n, n, k) for n, nbrs in G._adj.items() if n in nbrs for k in nbrs[n])
            else:
                return (
                    (n, n)
                    for n, nbrs in G._adj.items()
