...
class TestArrayRepr:
    ...
    def test_self_containing(self):
        ...
        second[()] = first
        assert_equal(
            repr(first), "array(array(array(..., dtype=object), dtype=object), dtype=object)"
        )
...
class TestArray2String:
    ...
    def test_structure_format_int(self):
        ...
        assert_equal(
            np.array2string(struct_2dint), "[([[ 0,  1], [ 2,  3]],) ([[12,  0], [ 0,  0]],)]"
        )
    ...
    def test_unstructured_void_repr(self):
        a = np.array(
            [27, 91, 50, 75, 7, 65, 10, 8, 27, 91, 51, 49, 109, 82, 101, 100], dtype="u1"
        ).view("V8")
...
class TestPrintOptions:
    ...
    def test_floatmode(self):
        x = np.array(
            [0.6104, 0.922, 0.457, 0.0906, 0.3733, 0.007244, 0.5933, 0.947, 0.2383, 0.4226],
            dtype=np.float16,
        )
        y = np.array(
            [
        ...
        assert_equal(
            repr(y), "array([0.2919, 0.5064, 0.2849, 0.4343, 0.7327, 0.3460, 0.0862, 0.3911])"
        )
        assert_equal(
            repr(z), "array([0.0000, 0.1000, 0.2000, 0.3000, 0.3999, 0.5000], dtype=float16)"
        )
        assert_equal(
            repr(w[::5]), "array([1.0000e+00, 1.0000e+05, 1.0000e+10, 1.0000e+15, 1.0000e+20])"
        )
    ...
    test_cases_gh_28679 = [
        ...
        (np.complex64([999999 + 999999j, 999999 + 999999j]), "[999999.+999999.j 999999.+999999.j]"),
        (
