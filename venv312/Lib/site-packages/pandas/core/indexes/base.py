...
class Index(IndexOpsMixin, PandasObject):
        ...
        if isinstance(data, (range, RangeIndex)):
            ...
            if tupleize_cols:
                ...
                if data and all(isinstance(e, tuple) for e in data):
                    ...
                    # error: Incompatible return value type (got "MultiIndex",
                    # expected "Self")
                    return MultiIndex.from_tuples(data, names=name)  # type: ignore[return-value]
    ...
    def sortlevel(
        ...
        if not isinstance(ascending, (list, bool)):
            raise TypeError(
                "ascending must be a single bool value or" "a list of bool values of length 1"
            )
    ...
    def _can_use_libjoin(self) -> bool:
        ...
        if type(self) is Index:
            ...
            return (
                ...
                or (isinstance(self.dtype, StringDtype) and self.dtype.storage == "python")
            )
    ...
    def _should_compare(self, other: Index) -> bool:
        ...
        if (other.inferred_type == "boolean" and is_any_real_numeric_dtype(self.dtype)) or (
    ...
    def get_slice_bound(self, label, side: Literal["left", "right"]) -> int:
        ...
        if side not in ("left", "right"):
            raise ValueError(
                "Invalid value for side kwarg, must be either " f"'left' or 'right': {side}"
            )
    ...
    def insert(self, loc: int, item) -> Index:
        ...
        if using_string_dtype() and is_string_dtype(out.dtype) and new_values.dtype == object:
    ...
    def _cmp_method(self, other, op):
        ...
        if isinstance(other, (np.ndarray, Index, ABCSeries, ExtensionArray)) and len(self) != len(
            other
        ):
