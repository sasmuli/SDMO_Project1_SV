...
def all_of_type(arg_type):
    ...
    def outer(func):
        ...
        def inner(*args, **kwargs):
            ...
            return tuple(
                Dispatchable(arg, arg_type) if not isinstance(arg, Dispatchable) else arg
...
def determine_backend_multi(dispatchables, *, domain, only=True, coerce=False, **kwargs):
    ...
    if "dispatch_type" in kwargs:
        ...
        dispatchables = tuple(
            d if isinstance(d, Dispatchable) else Dispatchable(d, disp_type) for d in dispatchables
        )
    else:
