...
class RandomState:
    ...
    def randint(  # type: ignore[misc]
        ...
        size: _ShapeLike | None = ...,
        dtype: (
            dtype[int64] | type[int64] | _Int64Codes | _SupportsDType[dtype[int64]] | None
        ) = ...,  # noqa: E501
    ) -> NDArray[int64]: ...
    @overload
    def randint(  # type: ignore[misc]
    ...
    def randint(  # type: ignore[misc]
        ...
        size: _ShapeLike | None = ...,
        dtype: (
            dtype[long] | type[int] | type[long] | _LongCodes | _SupportsDType[dtype[long]]
        ) = ...,  # noqa: E501
    ) -> NDArray[long]: ...
    @overload
    def randint(  # type: ignore[misc]
    ...
    @overload
    def zipf(self, a: _ArrayLikeFloat_co, size: _ShapeLike | None = ...) -> NDArray[long]: ...
    @overload
    def geometric(self, p: float, size: None = ...) -> int: ...  # type: ignore[misc]
    @overload
    def geometric(self, p: _ArrayLikeFloat_co, size: _ShapeLike | None = ...) -> NDArray[long]: ...
    @overload
    def hypergeometric(
    ...
    @overload
    def logseries(self, p: _ArrayLikeFloat_co, size: _ShapeLike | None = ...) -> NDArray[long]: ...
