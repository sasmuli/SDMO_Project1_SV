...
class _spbase:
    ...
    def _matmul_dispatch(self, other):
        ...
        if issparse(other):
            if N != other.shape[0]:
                raise ValueError(f"{err_prefix} (n,k={N}),(k={other.shape[0]},m)->(n,m)")
        ...
        if other.ndim == 1 or other.ndim == 2 and other.shape[1] == 1:
            ...
            if other.shape[0] != N:
                raise ValueError(f"{err_prefix} (n,k={N}),(k={other.shape[0]},1?)->(n,1?)")
    ...
    def mean(self, axis=None, dtype=None, out=None):
        ...
        if axis is None:
            return (inter_self / (self.shape[0] * self.shape[1])).sum(dtype=res_dtype, out=out)
