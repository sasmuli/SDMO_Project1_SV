...
class Binomial(Family):
    ...
    def __init__(self, link=None, check_link=True):  # , n=1.):
        ...
        super().__init__(link=link, variance=V.Binomial(n=self.n), check_link=check_link)
...
class NegativeBinomial(Family):
    ...
    def __init__(self, link=None, alpha=1.0, check_link=True):
        ...
        if link is None:
            link = L.Log()
        super().__init__(
            link=link, variance=V.NegativeBinomial(alpha=self.alpha), check_link=check_link
        )
