...
def assert_equal(actual, desired, *args, **kwargs):
    ...
    np.testing.assert_equal(_tensor_to_numpy(actual), _tensor_to_numpy(desired), *args, **kwargs)
...
def assert_class_wrapper_correctly_passes_arguments(
    ...
    **extra_args
    ...
    test_kwargs = {
        argument: "this_is_used_to_test_correct_passing_of_arguments" for argument in kwargs
    }
