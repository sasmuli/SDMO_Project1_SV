...
def test_results_vs_statespace(statespace_comparison):
    ...
    assert_almost_equal(ets_results.fittedvalues.values, statespace_results.fittedvalues.values)
...
def test_prediction_results_vs_statespace(statespace_comparison):
    ...
    assert_almost_equal(ets_summary["mean"].values, statespace_summary["mean"].values, 4)
...
def test_convergence_simple():
    ...
    assert_allclose(res.fittedvalues[10:], ets_res.fittedvalues[10:], rtol=1e-4, atol=1e-4)
