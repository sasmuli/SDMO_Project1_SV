...
if sys.version_info >= (3, 14):
    ...
    async def set_trace_async(
        *, header: str | None = None, commands: Iterable[str] | None = None
    ) -> None: ...
...
class Pdb(Bdb, Cmd):
    ...
    if sys.version_info >= (3, 14):
        def set_trace(
            self, frame: FrameType | None = None, *, commands: Iterable[str] | None = None
        ) -> None: ...
        async def set_trace_async(
            self, frame: FrameType | None = None, *, commands: Iterable[str] | None = None
        ) -> None: ...
    ...
    if sys.version_info >= (3, 14):
        def checkline(
            self, filename: str, lineno: int, module_globals: _ModuleGlobals | None = None
        ) -> int: ...
    else:
