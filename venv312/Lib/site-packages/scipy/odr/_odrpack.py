...
class Model:
    ...
    def __init__(
        self, fcn, fjacb=None, fjacd=None, extra_args=None, estimate=None, implicit=0, meta=None
    ):
...
class ODR:
    ...
    def _check(self):
        ...
        if self.data.x.size == 0:
            warn(
                "Empty data detected for ODR instance. " "Do not expect any fitting to occur",
                OdrWarning,
                stacklevel=3,
            )
