...
assert_type(
    MAR_f4.sort(axis=0, kind="quicksort", order="K", endwith=False, fill_value=42.0, stable=False),
    None,
)
...
assert_type(
    MAR_2d_f4.repeat(MAR_i8, axis=None), np.ma.MaskedArray[tuple[int], np.dtype[np.float32]]
)
