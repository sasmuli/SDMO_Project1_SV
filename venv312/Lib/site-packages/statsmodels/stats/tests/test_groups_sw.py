...
class CheckPanelLagMixin:
    ...
    def calculate(cls):
        ...
        cls.alla = [
            (lag, sw.lagged_groups(cls.x, lag, g.groupidx))  # pylint: disable-msg=W0201
            for lag in range(5)
        ]
...
class TestBalanced(CheckPanelLagMixin):
    ...
    def setup_class(cls):
        ...
        # expected result
        cls.alle = {
            0: np.array([[1, 2, 3, 4, 5, 15, 16, 17, 18, 19, 110, 111, 112, 113, 114]]),
            1: np.array([[2, 3, 4, 5, 16, 17, 18, 19, 111, 112, 113, 114]]),
...
class TestUnBalanced(CheckPanelLagMixin):
    ...
    def setup_class(cls):
        ...
        cls.alle = {
            0: np.array(
                [[1, 2, 3, 13, 14, 15, 16, 17, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117]]
            ),
            1: np.array([[2, 3, 14, 15, 16, 17, 109, 110, 111, 112, 113, 114, 115, 116, 117]]),
            2: np.array([[3, 15, 16, 17, 110, 111, 112, 113, 114, 115, 116, 117]]),
