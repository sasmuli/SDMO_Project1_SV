...
def binary_closing_signature(input, structure=None, iterations=1, output=None, *args, **kwds):
...
def binary_fill_holes_signature(input, structure=None, output=None, origin=0, *args, **kwargs):
    return array_namespace(input, structure, _skip_if_dtype(output))
...
def binary_propagation_signature(input, structure=None, mask=None, output=None, *args, **kwds):
...
def gaussian_filter1d_signature(input, sigma, axis=-1, order=0, output=None, *args, **kwds):
    return array_namespace(input, _skip_if_dtype(output))
...
def generic_filter1d_signature(input, function, filter_size, axis=-1, output=None, *args, **kwds):
    return array_namespace(input, _skip_if_dtype(output))
...
def geometric_transform_signature(input, mapping, output_shape=None, output=None, *args, **kwds):
    return array_namespace(input, _skip_if_dtype(output))
...
def median_filter_signature(input, size=None, footprint=None, output=None, *args, **kwds):
    return array_namespace(input, footprint, _skip_if_dtype(output))
...
def rank_filter_signature(input, rank, size=None, footprint=None, output=None, *args, **kwds):
    return array_namespace(input, footprint, _skip_if_dtype(output))


def rotate_signature(input, angle, axes=(1, 0), reshape=True, output=None, *args, **kwds):
    return array_namespace(input, _skip_if_dtype(output))
...
def spline_filter1d_signature(input, order=3, axis=-1, output=np.float64, *args, **kwds):
    return array_namespace(input, _skip_if_dtype(output))
