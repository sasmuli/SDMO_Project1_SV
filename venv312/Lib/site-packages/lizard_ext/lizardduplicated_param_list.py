...
class LizardExtension(ExtensionBase):
    ...
    def cross_file_process(self, fileinfos):
        ...
        for fileinfo in fileinfos:
            flt = [
                f for f in fileinfo.function_list if len(f.parameters) >= DEFAULT_MIN_PARAM_COUNT
            ]
    ...
    def _reduce_again(self, fileinfo):
        for flist in fileinfo.function_list:
            flist.parameter_list_duplicates = self.all_count[self._parameters(flist)]
            flist.parameter_list_duplicated_in_files = self.all_count_per_file[
