...
def _cast_to_stata_types(data: DataFrame) -> DataFrame:
    ...
    for col in data:
        ...
        is_nullable_int = (
            isinstance(data[col].dtype, ExtensionDtype) and data[col].dtype.kind in "iub"
        )
    ...
    def _do_select_columns(self, data: DataFrame, columns: Sequence[str]) -> DataFrame:
        if not self._column_selector_set:
            ...
            if unmatched:
                ...
                raise ValueError(
                    "The following columns were not " f"found in the Stata data set: {joined}"
                )
    ...
    def __init__(
        ...
        *,
        ...
        if version is None:
            ...
            raise ValueError(
                "You must use version 119 for data sets containing more than" "32,767 variables"
            )
