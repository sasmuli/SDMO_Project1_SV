...
def test_rate_poisson_diff_consistency(method):
    ...
    pv2 = smr.test_poisson_2indep(
        count1, n1, count2, n2, value=ci[1], method=method, compare="diff", alternative="smaller"
    ).pvalue
...
def test_rate_poisson_ratio_consistency(method):
    ...
    pv2 = smr.test_poisson_2indep(
        count1, n1, count2, n2, value=ci[1], method=method, compare=compare, alternative="smaller"
    ).pvalue
