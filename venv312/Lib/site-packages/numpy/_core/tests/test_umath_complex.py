...
class TestComplexAbsoluteMixedDTypes:
    ...
    def test_array(self, stride, astype, func):
        ...
        vec = np.array(
            [
                (0, 0.0, 0, -31.666483, 200, 0.0, 0.0, 1.0, 3.0 + 4.0j, 613090),  # noqa: E203,E501
                (1, 0.0, 0, 260.91525, 42, 0.0, 0.0, 1.0, 5.0 + 12.0j, 787315),  # noqa: E203,E501
                (1, 0.0, 0, 52.15155, 42, 0.0, 0.0, 1.0, 8.0 + 15.0j, 806641),  # noqa: E203,E501
                (1, 0.0, 0, 52.430195, 42, 0.0, 0.0, 1.0, 7.0 + 24.0j, 1363540),  # noqa: E203,E501
                (2, 0.0, 0, 304.43646, 58, 0.0, 0.0, 1.0, 20.0 + 21.0j, 787323),  # noqa: E203,E501
                (3, 0.0, 0, 299.42108, 52, 0.0, 0.0, 1.0, 12.0 + 35.0j, 787332),  # noqa: E203,E501
                (
                    4,
                    0.0,
                    0,
                ...
                (4, 0.0, 0, 76.83787, 28, 0.0, 0.0, 1.0, 28.0 + 45.0j, 1321869),  # noqa: E203,E501
