...
class TestTheilTextile:
    ...
    def test_basic(self):
        ...
        assert_allclose(self.res1.fittedvalues, self.res_predict["fittedvalues"], atol=5e7)
...
class CheckEquivalenceMixin:
    ...
    def test_attributes(self):
        ...
        assert_allclose(self.res1.fittedvalues, self.res1.fittedvalues, rtol=1e-3, atol=1e-4)
