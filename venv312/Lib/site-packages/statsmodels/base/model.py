...
class LikelihoodModel(Model):
    ...
    def _fit_zeros(
        self, keep_index=None, start_params=None, return_auxiliary=False, k_params=None, **fit_kwds
    ):
...
class LikelihoodModelResults(Results):
    ...
    def t_test(self, r_matrix, cov_p=None, use_t=None):
        ...
        if use_t:
            ...
            return ContrastResults(
                effect=_effect, statistic=_t, sd=_sd, df_denom=df_resid, distribution="norm"
            )
    ...
    def wald_test(
        self, r_matrix, cov_p=None, invcov=None, use_f=None, df_constraints=None, scalar=None
    ):
        """
