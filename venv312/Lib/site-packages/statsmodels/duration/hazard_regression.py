...
class PHReg(model.LikelihoodModel):
    ...
    @Appender(
        _predict_docstring
        % {"params_doc": _predict_params_doc, "cov_params_doc": _predict_cov_params_docstring}
    )
    def predict(
        self,
        params,
...
class PHRegResults(base.LikelihoodModelResults):
    ...
    def predict(
        self, endog=None, exog=None, strata=None, offset=None, transform=True, pred_type="lhr"
    ):
