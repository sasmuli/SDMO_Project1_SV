...
def generate_princomp(xo, filen="testsave.py"):
    ...
    np.set_printoptions(precision=14, linewidth=100)
    res_princomp.save(
        filename=filen, header=False, comment="mlab.princomp(x[:20,]-x[:20,].mean(0), nout=3)"
    )
...
if __name__ == "__main__":
    ...
    res_pacf.pacf100, res_pacf.lags100, res_pacf.bounds100 = mlab.parcorr(x100, [], 2, nout=3)
    res_pacf.pacf1000, res_pacf.lags1000, res_pacf.bounds1000 = mlab.parcorr(x1000, [], 2, nout=3)
    res_pacf.save(filename=filen, header=True)

    res_acf = HoldIt("mlacf")
    res_acf.comment = "mlab.autocorr(x, [], 2, nout=3)"
    res_acf.acf100, res_acf.lags100, res_acf.bounds100 = mlab.autocorr(x100, [], 2, nout=3)
    res_acf.acf1000, res_acf.lags1000, res_acf.bounds1000 = mlab.autocorr(x1000, [], 2, nout=3)
    ...
    res_ccf.ccf100, res_ccf.lags100, res_ccf.bounds100 = mlab.crosscorr(
        x100[4:], x100[:-4], [], 2, nout=3
    )
    res_ccf.ccf1000, res_ccf.lags1000, res_ccf.bounds1000 = mlab.crosscorr(
