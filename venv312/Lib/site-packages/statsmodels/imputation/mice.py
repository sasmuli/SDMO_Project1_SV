...
class MICEData:
    ...
    def plot_fit_obs(
        self, col_name, lowess_args=None, lowess_min_n=40, jitter=None, plot_points=True, ax=None
    ):
        """
    ...
    def plot_imputed_hist(
        self, col_name, ax=None, imp_hist_args=None, obs_hist_args=None, all_hist_args=None
    ):
        """
    ...
    def impute_pmm(self, vname):
        ...
        endog_obs, exog_obs, exog_miss, predict_obs_kwds, predict_miss_kwds = self.get_split_data(
            vname
        )
