...
def cache_from_source(
    path: StrPath, debug_override: bool | None = None, *, optimization: Any | None = None
) -> str: ...
...
if sys.version_info >= (3, 11):
    class NamespaceLoader(importlib.abc.InspectLoader):
        ...
        def exec_module(self, module: types.ModuleType) -> None: ...
        @deprecated(
            "Deprecated since Python 3.10; will be removed in Python 3.15. Use `exec_module()` instead."
        )
        def load_module(self, fullname: str) -> types.ModuleType: ...
