...
class LizardExtension(ExtensionBase):
    ...
    FUNCTION_INFO = {
        "fan_in": {"caption": " fan_in ", "average_caption": " avg_fan_in "},
        "fan_out": {"caption": " fan_out ", "average_caption": " avg_fan_out "},
        "general_fan_out": {
    ...
    def _add_to_general_fan_out(self):
        ...
        for other_func in self.all_methods.values():
            ...
            for idx in bracket_indexes[1:]:
                # Suggestion ?
                if other_func.tokens[idx - 1] not in (structures | punctuations):
