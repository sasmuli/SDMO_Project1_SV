...
def fit_elasticnet(
    ...
    fgh_list = [
        _gen_npfuncs(k, L1_wt, alpha, loglike_kwds, score_kwds, hess_kwds) for k in range(k_exog)
    ]
...
wrap.populate_wrapper(RegularizedResultsWrapper, RegularizedResults)  # noqa:E305
