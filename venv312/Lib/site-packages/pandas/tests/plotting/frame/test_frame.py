...
class TestDataFramePlots:
    ...
    def test_boxplot_vertical_subplots(self, hist_df):
        ...
        axes = _check_plot_works(df.plot.box, default_axes=True, subplots=True, logx=True, **kwargs)
    ...
    def test_secondary_axis_font_size(self, method):
        # GH: 12565
        df = (
            DataFrame(np.random.default_rng(2).standard_normal((15, 2)), columns=list("AB"))
    ...
    def test_group_subplot_invalid_column_name(self):
        ...
        if Version(np.__version__) < Version("2.0.0"):
            ...
            with pytest.raises(ValueError, match=r"Column label\(s\) \[np\.str\_\('bad_name'\)\]"):
                df.plot(subplots=[("a", "bad_name")])
