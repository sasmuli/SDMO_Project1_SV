...
class PostScriptLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"(\-|\+)?([0-9]+\.?|[0-9]*\.[0-9]+|[0-9]+\.[0-9]*)((e|E)[0-9]+)?" + delimiter_end,
                Number.Float,
            ),
            ...
            (
                r"(eq|ne|g[et]|l[et]|and|or|not|if(?:else)?|for(?:all)?)" + delimiter_end,
                Keyword.Reserved,
            ),
            (
                words(
    ...
    tokens = {
        "root": [
            ...
            (
                r"([a-zA-Z_]\w*)(\s*)(\()(.*?)(\))(\s*)(=)",
                bygroups(
                    Name.Function, Whitespace, Punctuation, Text, Punctuation, Whitespace, Operator
                ),
                "genericargs",
            ),
