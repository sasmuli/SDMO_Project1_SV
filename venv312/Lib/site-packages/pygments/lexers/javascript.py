...
class KalLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (r"\?|:|_(?=\n)|==?|!=|-(?!>)|[<>+*/-]=?", Operator),
            (
                r"\b(and|or|isnt|is|not|but|bitwise|mod|\^|xor|exists|" r"doesnt\s+exist)\b",
                Operator.Word,
            ),
...
class LiveScriptLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (
                r"(?<![.$])(true|false|yes|no|on|off|" r"null|NaN|Infinity|undefined|void)\b",
                Keyword.Constant,
            ),
            (
    ...
    tokens = {
        ...
        "lasso": [
            ...
            (
                r"(self)(\s*)(->)(\s*)('[a-z_][\w.]*')",
                bygroups(
                    Name.Builtin.Pseudo, Whitespace, Operator, Whitespace, Name.Variable.Class
                ),
            ),
            (
                r"(\.\.?)(\s*)([a-z_][\w.]*(=(?!=))?)",
...
class CoffeeScriptLexer(RegexLexer):
    ...
    tokens = {
        ...
        "root": [
            ...
            (
                r"(?<![.$])(true|false|yes|no|on|off|null|" r"NaN|Infinity|undefined)\b",
                Keyword.Constant,
            ),
            (
                r"(Array|Boolean|Date|Error|Function|Math|"
...
class EarlGreyLexer(RegexLexer):
    ...
    tokens = {
        ...
        "keywords": [
            ...
            (
                words(("this", "self", "@"), prefix=r"(?<![\w\-$.])", suffix=r"(?![\w\-$])"),
                Keyword.Constant,
            ),
            (
                words(
...
class NodeConsoleLexer(Lexer):
    ...
    def get_tokens_unprocessed(self, text):
        ...
        for match in line_re.finditer(text):
            ...
            if line.startswith("> "):
                insertions.append(
                    (len(curcode), [(0, Generic.Prompt, line[:1]), (1, Whitespace, line[1:2])])
                )
