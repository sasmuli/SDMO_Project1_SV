...
and Synthesis'
    ...
    p = [1e-5, 1e-4, 0.001, 0.01, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5]
    ...
    print(
        "Pe = [H(X|Y) -1]/log(K) = %0.4g"
        % ((np.mean([0, shannonentropy(w2[1]), shannonentropy(w2[2])]) - 1) / np.log2(3))
    )
    print("such that more information lowers the error")

    ### Stochastic processes
    markovchain = np.array([[0.553, 0.284, 0.163], [0.465, 0.312, 0.223], [0.420, 0.322, 0.258]])
