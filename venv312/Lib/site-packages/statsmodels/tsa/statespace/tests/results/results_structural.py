...
local_linear_deterministic_trend = {
    "models": [
        {"irregular": True, "level": True, "stochastic_level": True, "trend": True},
...
smooth_trend = {
    "models": [
        {"irregular": True, "level": True, "trend": True, "stochastic_trend": True},
        {"level": "smooth trend"},
        {"level": "strend"},
    ],
...
cycle = {
    "models": [{"irregular": True, "cycle": True, "stochastic_cycle": True, "damped_cycle": True}],
...
seasonal_approx_diffuse.update(
    {"params": [38.1704278, 0.1], "llf": -678.8138005, "kwargs": {"loglikelihood_burn": 0}}
)

freq_seasonal = {
    "models": [{"irregular": True, "freq_seasonal": [{"period": 5}]}],
...
freq_seasonal_approx_diffuse.update(
    {"params": [38.95353592, 0.05], "llf": -688.9697249, "kwargs": {"loglikelihood_burn": 0}}
)
...
reg_approx_diffuse.update(
    {"params": [2.215447924], "llf": -379.6233483, "kwargs": {"loglikelihood_burn": 0}}
)

rtrend_ar1 = {
    "models": [
        {"level": True, "trend": True, "stochastic_trend": True, "autoregressive": 1},
