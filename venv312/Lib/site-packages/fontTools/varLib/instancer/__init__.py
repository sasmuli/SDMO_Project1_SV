        ...
        if usingAvar and "avar" in varfont:
            ...
            if getattr(avar, "majorVersion", 1) >= 2 and avar.table.VarStore:
                ...
                if not pinnedAxes.issuperset(avarSegments):
                    raise NotImplementedError("Partial-instancing avar2 table is not supported")
...
def instantiateVariableFont(
    ...
    *,
    ...
    if "CFF2" in varfont:
        downgradeCFF2 = instantiateCFF2(varfont, normalizedLimits, downgrade=downgradeCFF2)
