    ...
    def __init__(
        ...
        **fmt_dict,
        ...
        self.output_formats = dict(
            txt=self._txt_fmt, csv=self._csv_fmt, html=self._html_fmt, latex=self._latex_fmt
        )
...
class Row(list):
    ...
    def __init__(
        self, seq, datatype="data", table=None, celltype=None, dec_below="row_dec_below", **fmt_dict
    ):
        """
        Parameters
        ----------
...
default_fmts = dict(
    html=default_html_fmt, txt=default_txt_fmt, latex=default_latex_fmt, csv=default_csv_fmt
)
