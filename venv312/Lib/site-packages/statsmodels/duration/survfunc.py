...
class CumIncidenceRight:
    ...
    def __init__(
        self, time, status, title=None, freq_weights=None, exog=None, bw_factor=1.0, dimred=True
    ):
...
class SurvfuncRight:
    ...
    def __init__(
        self, time, status, entry=None, title=None, freq_weights=None, exog=None, bw_factor=1.0
    ):
