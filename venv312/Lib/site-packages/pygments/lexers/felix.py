...
class FelixLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            # Keywords
            (
                words(("axiom", "ctor", "fun", "gen", "proc", "reduce", "union"), suffix=r"\b"),
                Keyword,
                "funcname",
            ),
            (
            ...
            # -- Hex Float
            (
                r"0[xX]([0-9a-fA-F_]*\.[0-9a-fA-F_]+|[0-9a-fA-F_]+)" r"[pP][+\-]?[0-9_]+[lLfFdD]?",
                Number.Float,
            ),
            # -- DecimalFloat
            (
                r"[0-9_]+(\.[0-9_]+[eE][+\-]?[0-9_]+|" r"\.[0-9_]*|[eE][+\-]?[0-9_]+)[lLfFdD]?",
                Number.Float,
            ),
