...
class CheckDistEquivalence:
    ...
    def test_rvs(self):
        ...
        if np.any(np.abs(mean_d) < 1):
            ...
            assert_almost_equal(mean_s / mean_d, 1.0, 0)  # tests 0.5<meanration<1.5
...
if __name__ == "__main__":
    ...
    print("\nsquare of standard normal random variable is chisquare with dof=1 distributed")
    print(
        "sqnorm  cdf for (%3.2f, %3.2f, %3.2f):" % tuple(xx), squarenormalg.cdf(xx, loc=l, scale=s)
    )
    print(
    ...
    print(
        "sqnorm  pdf for (%3.2f, %3.2f, %3.2f):" % tuple(xx), squarenormalg.pdf(xx, loc=l, scale=s)
    )
    print("chi2    pdf for (%3.2f, %3.2f, %3.2f):" % tuple(xx), stats.chi2.pdf(xx, 1))
    print(
    ...
    print(
        "absnorm 1-sf for (%3.2f, %3.2f, %3.2f):" % tuple(xx), 1 - absnormalg.sf(xx, loc=l, scale=s)
    )
