...
class FantomLexer(RegexLexer):
    ...
    tokens = {
        ...
        "fieldKeywords": [
            (r"\b(abstract|const|final|native|override|static|virtual|" r"readonly)\b", Keyword)
        ],
        "otherKeywords": [
            (
                words(
        ...
        "root": [
            ...
            (
                s(r"($type)([ \t]+)($id)(\s*)(:=)"),
                bygroups(
                    using(this, state="inType"), Whitespace, Name.Variable, Whitespace, Operator
                ),
            ),
            # var := val
            ...
            (
                ...
                bygroups(
                    using(this, state="inType"), Whitespace, Name.Function, Whitespace, Punctuation
                ),
                "insideMethodDeclArgs",
            ),
            # ArgType argName,
            (
                s(r"($type)(\s+)($id)(\s*)(,)"),
                bygroups(
                    using(this, state="inType"), Whitespace, Name.Variable, Whitespace, Punctuation
                ),
            ),
            # ArgType argName)
