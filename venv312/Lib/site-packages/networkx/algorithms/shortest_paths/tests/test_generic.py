...
class TestGenericPath:
    ...
    def test_shortest_path(self):
        ...
        assert nx.shortest_path(self.directed_cycle, 0, 3, weight="weight", method="dijkstra") == [
            0,
            1,
            2,
            3,
        ...
        assert nx.shortest_path(self.neg_weights, 0, 3, weight="weight", method="bellman-ford") == [
            0,
            2,
            3,
        ]
    ...
    def test_shortest_path_length(self):
        ...
        assert (
            nx.shortest_path_length(self.cycle, 0, 3, weight="weight", method="bellman-ford") == 3
        )
        # confirm bad method rejection
